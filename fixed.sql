...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `cond`(poster_id INT) RETURNS varchar(100) CHARSET latin1
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `cond_auction`(poster_id INT) RETURNS varchar(100) CHARSET latin1
BEGIN
  DECLARE poster_size VARCHAR (100) ;
  IF poster_id != '' 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `countMax`(auctionId INT) RETURNS varchar(100) CHARSET latin1
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `highest_user`(auctionId INT) RETURNS varchar(100) CHARSET latin1
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `poster_size`(poster_id INT) RETURNS varchar(100) CHARSET latin1
BEGIN
  DECLARE poster_size VARCHAR (100) ;
  IF poster_id != '' 
  THEN SET poster_size = 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `poster_size_auction`(poster_id INT) RETURNS varchar(100) CHARSET latin1
BEGIN
  DECLARE poster_size VARCHAR (100) ;
  IF poster_id != '' 
  THEN SET poster_size = 
