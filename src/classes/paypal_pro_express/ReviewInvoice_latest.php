...
if(!isset($token)) {
	...
	*/
   	$returnURL =urlencode(SITE_URL.'/classes/paypal_pro_express/ReviewInvoice.php?currencyCodeType='.$currencyCodeType.'&paymentType='.$paymentType);
   	$cancelURL =urlencode(SITE_URL."my_invoice.php?mode=do_express_checkout".$_REQUEST['invoice_id']);
	...
	*/
   	...
   	if($ack=="SUCCESS"){
		...
		header("location:".SITE_URL."my_invoice.php?mode=do_express_checkout&invoice_id=".$invoice_id);
		exit;
	}
} else {
   ...
   if($ack == 'SUCCESS' || $ack == 'SUCCESSWITHWARNING'){
   	...
   	//exit;
   		header("location:".SITE_URL."my_invoice.php?mode=do_express_checkout_details&invoice_id=".$_SESSION['invoice_id']."&token=".$_REQUEST['token']);
	    exit;
   } else  {
		//Redirecting to APIError.php to display errors.
		//$location = "APIError.php";
