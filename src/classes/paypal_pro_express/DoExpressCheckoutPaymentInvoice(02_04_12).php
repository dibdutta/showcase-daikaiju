...
if($ack != 'SUCCESS' && $ack != 'SUCCESSWITHWARNING'){
	...
	exit;
		...
		$data = array('billing_address' => $billing_address, 'shipping_address' => $shipping_address, 'additional_charges' => $additional_charges,
		...
		$invoiceObj->updateData(TBL_AUCTION, array('auction_payment_is_done' => 1), array('auction_id' => $data[0]['fk_auction_id']), true);
		
		$invoiceObj->generateSellerInvoice($_SESSION['invoice_id']);
		$invoiceObj->mailInvoice($_SESSION['invoice_id']);
