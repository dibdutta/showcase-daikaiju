<html>
	<head>
		...
		<link href="{$actualPathJSCSS}css/adminStyle.css" rel="stylesheet">
        <link href="{$actualPathJSCSS}css/dropdown_menu.css" rel="stylesheet">
        <script type="text/javascript" src="{$actualPathJSCSS}js/jquery-1.4.2.js"></script>
		<!--<script src="{$actualPathJSCSS}js/jquery-1.10.2.js"></script>-->
        <script type="text/javascript" src="{$actualPathJSCSS}js/dropdown_menu.js"></script>
