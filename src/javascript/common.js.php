                        ...
                        if(parseInt(bidDataArr[i]['bid_count']) > 0){
                            ...
                            if(curr_user!=''){
                               if(curr_user==highest_user){
                                 var winner= "<img src='<?php echo rtrim(getenv("CDN_STATIC_URL") ?: "https://d294w6g1afjpvs.cloudfront.net", "/"); ?>/images/winning-bid-img.png' alt='Winner' title='Winner'>";
                               }else{
                                 //var winner= "<img src='<?php echo rtrim(getenv("CDN_STATIC_URL") ?: "https://d294w6g1afjpvs.cloudfront.net", "/"); ?>/images/winning-bid-img.png' alt='Loosing' title='Loosing'>";
                               }
                            }
