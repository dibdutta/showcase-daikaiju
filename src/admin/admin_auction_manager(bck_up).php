...
//	echo $_REQUEST['invoice_id'];
	...
	$new_cost.="<div style='float:left; width:144px; border-right:1px solid #cccccc; height:18px; '><img  src='../admin_images/delete_charge.jpg' id='del_amnt_$dynamic_id' onclick='del_charge(this.id)'></div>";	
    $new_cost.="<div style='float:left; width:289px;border-right:1px solid #cccccc;height:18px; '><input type='hidden' name='desc_del_amnt_$dynamic_id' id='desc_del_amnt_$dynamic_id' value='$desc' />(+) $desc</div>";
    $new_cost.="<div style='float:left; width:132px; text-align:left; height:18px; padding-left:2px;'><input type='hidden' name='input_del_amnt_$dynamic_id' id='input_del_amnt_$dynamic_id' value='$amnt' />$$amnt</div>";
    $new_cost.="</div>";
...
function delete_invoice_charge(){
 ...
 function update_invoice_discount(){
	...
	$dynamic_id=rand(1000,9999);
	$new_cost.="<div id='tr_del_amnt_$dynamic_id' style='width:100%; float:left;'>";
	$new_cost.="<div style='float:left; width:144px; border-right:1px solid #cccccc; height:18px; '><img  src='../admin_images/delete_charge.jpg' id='del_amnt_$dynamic_id' onclick='del_discount(this.id)'></div>";	
    $new_cost.="<div style='float:left; width:289px;border-right:1px solid #cccccc;height:18px;'><input type='hidden' name='desc_del_amnt_$dynamic_id' id='desc_del_amnt_$dynamic_id' value='$desc' />(-) $desc</div>";
    $new_cost.="<div style='float:left; width:132px; text-align:left; height:18px; padding-left:2px;'><input type='hidden' name='input_del_amnt_$dynamic_id' id='input_del_amnt_$dynamic_id' value='$amnt' />$$amnt</div>";
    $new_cost.="</div>";
