...
class Smarty_Compiler extends Smarty {
    ...
    function _compile_file($resource_name, $source_content, &$compiled_content)
    {
        ...
        $ldel = $this->_quote_replace($this->left_delimiter);
        $rdel = $this->_quote_replace($this->right_delimiter);
        $source_content = preg_replace_callback($search, function($matches) use ($ldel, $rdel) {
            return $ldel . 'php' . str_repeat("\n", substr_count($matches[0], "\n")) . $rdel;
        }, $source_content);
