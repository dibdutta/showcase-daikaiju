	...
	<tr>
		<td width="100%">
			<table width="100%" border="0" cellspacing="0" cellpadding="2">
				<tr>
					<td align="center" valign="top" class="bold_text">Manage Alternative Poster</td>
				</tr>
				{if $errorMessage<>""}
					<tr>
				...
				<tr>
					<td align="center">
						<form method="post" action="" name="configManager" id="configManager">
							<input type="hidden" name="mode" value="save_alternative_poster">
									...
									<td align="center">
										<table align="center" width='70%' border="0" cellpadding="2" cellspacing="1" class="header_bordercolor">
											<tr class="header_bgcolor" height="24">
												<td colspan="2" align="left" class="headertext">Alternative Poster</td>
											</tr>
                                            <tr class="tr_bgcolor">
											...
											<tr class="tr_bgcolor">
												<td class="bold_text" valign="top" width="36%"><span class="err">*</span>Title :</td>
											...
											<tr class="tr_bgcolor">
												<td class="bold_text" valign="top" width="36%">Artist:</td>
												<td class="smalltext"><input type="text" name="artist" value="{$artist}" size="40" class="look" /><br /></td>
											</tr>
                                            <tr class="tr_bgcolor">
                                            ...
                                            <tr class="tr_bgcolor">
												<td class="bold_text" valign="top"><span class="err">*</span>Price :</td>
											...
											<tr class="tr_bgcolor">
												<td class="bold_text" valign="top"><span class="err">*</span>Quantity :</td>
												<td class="smalltext"><input type="text" name="quantity" value="{$quantity}" maxlength="8" class="look-price" /><br /></td>
											</tr>
                                           
											
											<tr class="tr_bgcolor" id="minOfferDiv"   >
												<td class="bold_text" valign="top"></td>
												<td class="smalltext"><input type="text" name="field_1" value="{$field_1}"  class="look" /><br /></td>
											</tr>
											<tr class="tr_bgcolor" id="minOfferDiv"   >
												<td class="bold_text" valign="top"></td>
												<td class="smalltext"><input type="text" name="field_2" value="{$field_2}"  class="look" /><br /></td>
											</tr>
											<tr class="tr_bgcolor" id="minOfferDiv"   >
												<td class="bold_text" valign="top"></td>
												<td class="smalltext"><input type="text" name="field_3" value="{$field_3}" class="look" /><br /></td>
											</tr>
