								...
								<tr>
									<td align="center">
										<table align="center" width='70%' border="0" cellpadding="2" cellspacing="1" class="header_bordercolor">
                                            ...
                                            <tr class="tr_bgcolor">
												<td class="bold_text" valign="top"><span class="err">*</span>Minimum offer you will consider :</td>
												<td class="smalltext">${$auctionRow[0].auction_reserve_offer_price|number_format:2}<br /><span class="err">{$offer_price_err}</span></td>
											</tr>
                                            <tr class="tr_bgcolor">
												<td class="bold_text" valign="top">&nbsp;</td>
												<td class="smalltext"><input type="checkbox" name="is_percentage" value="1" {if $auctionRow[0].is_offer_price_percentage == 1} checked="checked" {/if} class="" disabled="disabled" />&nbsp;Amount as a percentage</td>
											</tr>
											<tr class="tr_bgcolor">
