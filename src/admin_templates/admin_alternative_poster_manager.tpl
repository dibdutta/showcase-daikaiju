...
function reset_date(ele) {
 ...
 function redirect_to_consignment(){
 	window.location.href="admin_alternate_poster.php?mode=create_alternate_posters&encoded_string={/literal}{$encoded_string}{literal}";
 }
 function view_all(){
 	window.location.href="admin_alternate_poster.php";
 }	
                ...
                <tr>
					...
					<table align="center" width="80%" border="0" cellspacing="1" cellpadding="2" >
							...
							<tr>
								...
								<td colspan="2" align="center">&nbsp; &nbsp;<input type="button"  value="Add Consignment Item" class="button" onclick="redirect_to_consignment()"></td>
							</tr>
						</table>
								...
								<table align="center" width="80%" border="0" cellspacing="1" cellpadding="2" class="header_bordercolor" >
									<tbody>
										<tr class="header_bgcolor" height="26">
                                            ...
                                            <td align="center" class="headertext" width="10%">Artist</td>
											 <td align="center" class="headertext" width="6%">Price</td>
											 <td align="center" class="headertext" width="6%">Quantity</td>
										...
										{section name=counter loop=$auctionRows}
											<tr id="tr_{$auctionRows[counter].auction_id}" class="{cycle values="odd_tr,even_tr"}">
												...
												<td align="center" class="smalltext">{$auctionRows[counter].artist}</td>
												<td align="center" class="smalltext">${$auctionRows[counter].auction_asked_price|number_format:2}</td>
                                                <td align="center" class="smalltext">{$auctionRows[counter].quantity}</td>
                                                ...
                                                {*if $auctionRows[counter].auction_is_approved == 0*}
                                                	<a href="{$adminActualPath}/admin_alternate_poster.php?mode=edit_alternative&auction_id={$auctionRows[counter].auction_id}&encoded_string={$encoded_string}" class="view_link"><img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_edit.gif" align="absmiddle" alt="Update" title="Update" border="0" class="changeStatus" /></a>
                                                ...
                                                {*/if*}
                                                 <a href="{$adminActualPath}/admin_auction_manager.php?mode=view_fixed&auction_id={$auctionRows[counter].auction_id}&encoded_string={$encoded_string}" class="view_link"><img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_open.gif" align="absmiddle" alt="Details" title="Details" border="0" class="changeStatus" /></a> 
                                                    <!--&nbsp;|&nbsp;<a href="#" class="view_link"><img src="{$smarty.const.CLOUD_STATIC_ADMIN}delete_image.png" align="absmiddle" alt="Delete" title="Delete" border="0" class="changeStatus" /></a>&nbsp;&nbsp;-->
                                             		{if $search == 'selling' || $search == 'sold' || $auctionRows[counter].auction_is_approved == '1'}<a href="{$adminActualPath}/admin_alternate_poster.php?mode=view_details_sell_status&auction_id={$auctionRows[counter].auction_id}&encoded_string={$encoded_string}" class="view_link"><img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_view.gif" align="absmiddle" alt="View Sold Status" title="View Sold Status" border="0" class="changeStatus" /></a>{/if}
													{if $search == 'sold'}
