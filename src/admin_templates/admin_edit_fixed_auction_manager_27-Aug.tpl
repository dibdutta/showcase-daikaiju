									...
									<td align="center">
										<table align="center" width='70%' border="0" cellpadding="2" cellspacing="1" class="header_bordercolor">
											...
											<tr class="tr_bgcolor">
												...
												<td class="smalltext"><input type="text" name="poster_title" value="{$auctionRow[0].poster_title}"  {if $auctionRow[0].auction_is_approved!='0'} readonly="readonly" {/if}  style="background-color:#CCCCCC;" size="40" class="look" style="background-color:#CCCCCC;" /><br /><span class="err">{$poster_title_err}</span></td>
											</tr>
                                            <tr class="tr_bgcolor">
                                                	...
                                                	<table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                    	...
                                                    	<tr>
                                                        	<td align="center">
                                                                ...
                                                                <div>Recommended photo size is minimum of 780KB(1500 pixels longest side) to 1.26MB(2000 pixels longest side)</div>
                                            ...
                                            <tr class="tr_bgcolor">
												<td class="bold_text" valign="top">Offer Price :</td>
												<td class="smalltext"><input type="text" name="offer_price" value="{$auctionRow[0].auction_reserve_offer_price}" {if $auctionRow[0].auction_is_approved != 0} readonly="readonly" style="background-color:#CCCCCC;" {/if} maxlength="8" class="look-price" />.00<br /><span class="err">{$offer_price_err}</span></td>
											</tr>
                                            <tr class="tr_bgcolor">
												<td class="bold_text" valign="top">&nbsp;</td>
												<td class="smalltext">
                                                {if $auctionRow[0].auction_is_approved == 0} 
                                                <input type="checkbox" name="is_percentage" value="1" {if $auctionRow[0].is_offer_price_percentage == 1} checked="checked" {/if} {if $auctionRow[0].auction_is_approved != 0} disabled="disabled" style="background-color:#CCCCCC;"{/if} />
                                                {else}
                                                	{if $auctionRow[0].is_offer_price_percentage == 1}
                                                    <input type="hidden" name="is_percentage" value="1" />
                                                    <img src="{$actualPath}/admin_images/checked-icon.png">
                                                    {else}
                                                    <input type="hidden" name="is_percentage" value="0" />
                                                    <img src="{$actualPath}/admin_images/disabled-icon.png">
                                                    {/if}
                                                {/if}&nbsp;Offer price in percentage</td>
											</tr>
											<tr class="tr_bgcolor">
