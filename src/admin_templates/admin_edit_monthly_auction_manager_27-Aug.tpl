									...
									<td align="center">
										<table align="center" width='70%' border="0" cellpadding="2" cellspacing="1" class="header_bordercolor">
                                            ...
                                            <tr class="tr_bgcolor">
                                                ...
                                                {$auctionRow[0].event_title}&nbsp;({$auctionRow[0].event_start_date|date_format '%D'} - {$auctionRow[0].event_end_date|date_format '%D'})
                                                {/if}
                                                </td>
                                            </tr>
                                            <tr class="tr_bgcolor">
                                            ...
                                            <tr class="tr_bgcolor">
												...
												<td class="smalltext"><input type="text" name="reserve_price" value="{$auctionRow[0].auction_reserve_offer_price}" {if $auctionRow[0].auction_is_approved != 0} readonly="readonly" style="background-color:#CCCCCC;"{/if} maxlength="8" class="look-price" />.00<br /><span class="err">{$reserve_price_err}</span></td>
											</tr>
