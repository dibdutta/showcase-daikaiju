												...
												<td valign="top">
													<select name="fk_shop_cat_id" id="fk_shop_cat_id" class="look">
														...
														{section name=sc loop=$shopCategories}
															<option value="{$shopCategories[sc].shop_cat_id}" {if $subcat.fk_shop_cat_id == $shopCategories[sc].shop_cat_id}selected="selected"{/if}>{$shopCategories[sc].shop_cat_name}</option>
														{/section}
													</select>
