				...
				<tr>
					<td align="center">
						<form method="post" action="" name="configManager" id="configManager">
							<input type="hidden" name="mode" value="update_alternative">
									...
									<td align="center">
										<table align="center" width='70%' border="0" cellpadding="2" cellspacing="1" class="header_bordercolor">
											...
											<tr class="tr_bgcolor">
												...
												<td class="smalltext"><input type="text" name="artist" value="{$auctionRow[0].artist}"  class="look" /></td>
											</tr>
                                            <tr class="tr_bgcolor">
											...
											<tr class="tr_bgcolor" id="minOfferDiv"   >
												<td class="bold_text" valign="top">Quantity :</td>
												<td class="smalltext"><input type="text" name="quantity" value="{$auctionRow[0].quantity}" maxlength="8" class="look-price" /><br /></td>
											</tr>
											
											<tr class="tr_bgcolor" id="minOfferDiv"   >
												<td class="bold_text" valign="top"></td>
												<td class="smalltext"><input type="text" name="field_1" value="{$auctionRow[0].field_1}" class="look" /><br /></td>
											</tr>
											<tr class="tr_bgcolor" id="minOfferDiv"   >
												<td class="bold_text" valign="top"></td>
												<td class="smalltext"><input type="text" name="field_2" value="{$auctionRow[0].field_2}"  class="look" /><br /></td>
											</tr>
											<tr class="tr_bgcolor" id="minOfferDiv"   >
												<td class="bold_text" valign="top"></td>
												<td class="smalltext"><input type="text" name="field_3" value="{$auctionRow[0].field_3}"  class="look" /><br /></td>
											</tr>
