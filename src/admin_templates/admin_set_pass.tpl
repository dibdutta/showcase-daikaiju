			...
			<table width="100%" border="0" cellspacing="0" cellpadding="10">
				<tr>
					<td valign="top" align="left" width="35%">
						<img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_login.gif" alt="" border="0"><br><strong>Welcome to</strong><br>{$smarty.const.ADMIN_WELCOMETEXT}<br><br>Reset your password.
					</td>
					<td valign="top" align="left" width="65%">
						<form action="{$smarty.const.PHP_SELF}" method="post" name="form" autocomplete="off" >
							...
							<table width="95%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td valign="top" align="left" class="page_heading">Reset Password</td>
								</tr>
								<tr>
									<td valign="top" align="left" class="dark_box">
										<table width="98%" border="0" cellspacing="0" cellpadding="3" align="center">
											<tr>
												<td valign="top" align="left" class="login_text"><strong>New Password</strong></td>
											</tr>
											<tr>
												<td valign="top" align="left" class="login_text"><input class="look" type="password" name="password" size="36" value="" maxlength="150" accesskey="e" /><br /><span class="err">{$password_err}</span></td>
											</tr>
											
											<tr>
												<td valign="top" align="left" class="login_text"><strong>Re-enter Password</strong></td>
											</tr>
											<tr>
												<td valign="top" align="left" class="login_text"><input class="look" type="password" name="confirm_password" size="36" value="" maxlength="150" accesskey="e" /><br /><span class="err">{$confirm_password_err}</span></td>
											</tr>
											<tr>
