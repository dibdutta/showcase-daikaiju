				...
				<tr>
					<td align="center">
						<form method="post" action="" name="configManager" id="configManager">
							<input type="hidden" name="mode" value="reopen_fixed_auction">
									...
									<td align="center">
										<table align="center" width='70%' border="0" cellpadding="2" cellspacing="1" class="header_bordercolor">
											...
											<tr class="tr_bgcolor">
												...
												<td class="smalltext"><textarea name="poster_desc" class="look" cols="70" rows="6" readonly="readonly">{$posterRow[0].poster_desc}</textarea><br /><span class="err">{$poster_desc_err}</span></td>
											</tr>
                                            <tr class="tr_bgcolor">
                                            ...
                                            <tr class="tr_bgcolor">
												...
												<td class="smalltext"><input type="text" name="asked_price" size="30" value="{$auctionRow[0].auction_asked_price}" class="look"  readonly="readonly"/><br /><span class="err">{$asked_price_err}</span></td>
											</tr>
                                            <tr class="tr_bgcolor">
												<td class="bold_text" valign="top"><span class="err">*</span>Offer Price :</td>
												<td class="smalltext"><input type="text" name="offer_price" size="30" value="{$auctionRow[0].auction_reserve_offer_price}" class="look" readonly="readonly" /><br /><span class="err">{$offer_price_err}</span></td>
											</tr>
											<tr class="tr_bgcolor">
												<td class="bold_text" valign="top"><span class="err">*</span>Buy-now Price :</td>
												<td class="smalltext"><input type="text" name="buy_now" value="" maxlength="8" class="look-price" />.00<br /><span class="err">{$offer_price_err}</span></td>
											</tr>
                                            <tr class="tr_bgcolor">
												<td class="bold_text" valign="top">&nbsp;</td>
												<td class="smalltext"><input type="checkbox" name="is_percentage" value="1" {if $auctionRow[0].is_offer_price_percentage == 1} checked="checked" {/if} class="" disabled="disabled" />&nbsp;Offer price in percentage</td>
											</tr>
											<tr class="tr_bgcolor">
												<td class="bold_text" valign="top">Notes :</td>
												<td class="smalltext"><textarea name="auction_note" class="look" cols="70" rows="6" readonly="readonly">{$auctionRow[0].auction_note}</textarea><br /><span class="err">{$auction_note_err}</span></td>
											</tr>
