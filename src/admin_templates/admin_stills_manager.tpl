...
function reset_date(ele) {
 ...
 function redirect_to_consignment(){
 	window.location.href="admin_auction_manager.php?mode=create_stills&encoded_string={/literal}{$encoded_string}{literal}";
 }
 function view_all(){
					...
					<table align="center" width="80%" border="0" cellspacing="1" cellpadding="2" >
							...
							<tr>
								<td class="bold_text" align="center" colspan="2" >
                                    	...
                                    	<input type="hidden" name="mode" value="stills" />
										Select : 
									...
									<tbody>
										...
										{section name=counter loop=$auctionRows}
											<tr id="tr_{$auctionRows[counter].auction_id}" class="{cycle values="odd_tr,even_tr"}">
                                                ...
                                                {if $smarty.request.search == 'sold'}
                                                 <span id="c_b">
                                                	<input type="checkbox" name="poster_ids[]" id="poster_ids{$auctionRows[counter].auction_id}" value="{$auctionRows[counter].auction_id}" class="checkBox"  />
                                                 </span>
                                                {/if}
                                                ...
                                                {*if $auctionRows[counter].auction_is_approved == 0*}
                                                	<a href="{$adminActualPath}/admin_auction_manager.php?mode=edit_stills&auction_id={$auctionRows[counter].auction_id}&encoded_string={$encoded_string}" class="view_link"><img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_edit.gif" align="absmiddle" alt="Update" title="Update" border="0" class="changeStatus" /></a>
                                                    <a href="#" class="view_link" onclick="javascript: deleteConfirmRecord('{$adminActualPath}/admin_auction_manager.php?mode=delete_auction&auction_id={$auctionRows[counter].auction_id}&auction_type=4&encoded_string={$encoded_string}', 'auction','{$auctionRows[counter].auction_id}'); return false;"><img src="{$smarty.const.CLOUD_STATIC_ADMIN}delete_image.png" align="absmiddle" alt="Delete Auction" title="Delete Auction" border="0" class="changeStatus" /></a> 
                                                {*/if*}
                                                 <a href="{$adminActualPath}/admin_auction_manager.php?mode=view_fixed&auction_id={$auctionRows[counter].auction_id}&encoded_string={$encoded_string}" class="view_link"><img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_open.gif" align="absmiddle" alt="Details" title="Details" border="0" class="changeStatus" /></a> 
													...
													{/if}
													<a id="various_{$smarty.section.counter.index}" href="{$adminActualPath}/admin_auction_manager.php?mode=weekly_relist&id={$auctionRows[counter].auction_id}">
													<img src="{$smarty.const.CLOUD_STATIC_ADMIN}resetAdmin.jpg" id="{$smarty.section.counter.index}" align="absmiddle" alt="Reopen Auction" title="Relist" border="0" onclick="fancy_images(this.id)" width="20px" />
													</a>
												</td>
											</tr>
										{/section}
