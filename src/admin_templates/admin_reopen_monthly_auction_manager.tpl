...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td align="center">
						<form method="post" action="" name="configManager" id="configManager">
							<input type="hidden" name="mode" value="reopen_monthly_auction">
                            ...
                            <input type="hidden" name="decoded_string" value="{$decoded_string}" />
									...
									<td align="center">
										<table align="center" width='70%' border="0" cellpadding="2" cellspacing="1" class="header_bordercolor">
                                            ...
                                            <tr class="tr_bgcolor">
                                                ...
                                                <td class="smalltext">
                                                <select name="event_month" class="look" disabled="disabled">
                                                    <option value="" selected="selected">Select</option>
                                                    {section name=counter loop=$eventRows}
                                                        <option value="{$eventRows[counter].event_id}" {if $auctionRow[0].fk_event_id == $eventRows[counter].event_id} selected {/if}>{$eventRows[counter].event_title}</option>
                                                    {/section}
                                            ...
                                            <tr class="tr_bgcolor">
												...
												<td class="smalltext"><input type="text" name="reserve_price" size="30" value="{$auctionRow[0].auction_reserve_offer_price}" class="look" readonly="readonly" /><br /><span class="err">{$reserve_price_err}</span></td>
											</tr>
											<tr class="tr_bgcolor">
												<td class="bold_text" valign="top"><span class="err">*</span>New Buy-now Price:</td>
												<td class="smalltext"><input type="text" name="new_buy_now" size="30" value="" class="look-price" maxlength="8"  />.00<br /><span class="err">{$reserve_price_err}</span></td>
											</tr>
	...
	{else}
	<tr><td align="center" colspan="2">Sorry no record found</td></tr>	
	{/if}	
</table>
