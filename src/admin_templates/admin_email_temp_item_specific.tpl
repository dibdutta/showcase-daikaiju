    ...
    <tbody>
        <tr>
            ...
            <table cellspacing="0" cellpadding="0" border="0" width="752" style="background-color:#ffffff;">
                <tbody>
                    <tr>
                        <td colspan="5"><img height="22" width="752" src="{$smarty.const.CLOUD_STATIC}img_001.jpg" alt="" /></td>
                    </tr>
                    <tr>
                        ...
                        <td width="115">&nbsp;</td>
                        <td width="309" style="background-image:url({$smarty.const.CLOUD_STATIC}img_003.jpg); background-repeat:repeat-x; padding-left:10px;"><a style="color:#881318; font-family:Arial, Helvetica, sans-serif; text-decoration:none; font-size:15px;" target="_blank" href="{$banner_link}">{$banner_text}
                        </a></td>
            ...
            <table cellspacing="0" cellpadding="0" border="0" width="752" style="background-color:#881318;">
                <tbody>
                    <tr>
                        ...
                        <td width="65"><img height="49" width="65" src="{$smarty.const.CLOUD_STATIC}img_005.jpg" alt="" /></td>
                        ...
                        <td width="118"><img height="49" width="118" src="{$smarty.const.CLOUD_STATIC}img_008.jpg" alt="" /></td>
                    </tr>
                </tbody>
            </table>
            </td>
