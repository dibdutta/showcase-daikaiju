									...
									<tbody>
										<tr class="header_bgcolor" height="26">
											...
											<tr id="tr_{$auctionRows[counter].auction_id}" class="{cycle values="odd_tr,even_tr"}">
                                                ...
                                                <td align="center" class="smalltext"><img src="{$actualPath}/poster_photo/thumbnail/{$auctionArr[0].poster_thumb}"  /><br />{$auctionArr[0].poster_title}<br /><b>SKU: </b>{$auctionArr[0].poster_sku}</td>
												<td align="center" class="smalltext">
												{if $auctionArr[0].fk_auction_type_id=='2'}
                                                ...
                                                Item is Sold by Bidding &nbsp;<a href="{$actualPath}/admin/admin_auction_manager.php?mode=manage_invoice&auction_id={$auctionArr[0].auction_id}"><img alt="" src="../admin_images/invoiceButton.PNG" width="20" title="View Invoice" border='0'></a>
                                                {elseif $auctionArr[0].auction_is_sold=='2'}
                                                Item is Sold by Direct Buy Now. &nbsp;<a href="{$actualPath}/admin/admin_auction_manager.php?mode=manage_invoice&auction_id={$auctionArr[0].auction_id}"><img alt="" src="../admin_images/invoiceButton.PNG" width="20" title="View Invoice"  border='0'></a>
                                                {/if}
												</td>
											</tr>
									</tbody>
                                    ...
                                    {section name=counter loop=$auctionArr[0].bids}
                                        <tr class="{cycle values="odd_tr,even_tr"}">
                                            ...
                                            <td align="center" class="bold_text">
	                                            ...
	                                            &nbsp;&nbsp;<img src="{$adminImagePath}/winning-bid-img.png" border="0" title="winning" />
	                                            {/if}
	                                            {else}
	                                            ...
	                                            &nbsp;&nbsp;<img src="{$adminImagePath}/losing-bid-img.png" border="0" title="winning" />
	                                            {/if}
	                                            {/if}
	                                            {if ($auctionArr[0].bids[counter].bid_is_won=='1' || $auctionArr[0].highest_bid <= $auctionArr[0].bids[counter].bid_amount) && $auctionArr[0].auction_is_sold =='2'}
	                                            &nbsp;&nbsp;<img src="{$adminImagePath}/losing-bid-img.png" border="0" title="winning" />
	                                            ...
	                                            &nbsp;&nbsp;<img src="{$adminImagePath}/losing-bid-img.png" border="0" title="losing" />
	                                            {/if}
                                            </td>
                                        </tr>
                                    {/section}
