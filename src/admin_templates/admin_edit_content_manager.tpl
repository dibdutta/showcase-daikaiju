				...
				<tr>
					<td width="100%" align="center">
						<table align="center" width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<input type="hidden" name="mode" value="save_content">
							<input type="hidden" name="page_content_id" value="{$page_content_id}">
							...
							<tr>
								<td align="center">
									<table align="center" width="99%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr height="28">
											<td align="center"><input type="submit" name="" value="Save Content" class="button">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="" value="Cancel" class="button" onclick="javascript: location.href='{$actualPath}{$decoded_string}'; ">&nbsp;&nbsp;&nbsp;&nbsp;
											<input type="button" name="" value="View Template" class="button" onclick="javascript:window.open('{$actualPath}/{$page_name}','_blank');">
											</td>
										</tr>
									</table>
								</td>
