                        ...
                        <input type="hidden" id="invoice_id" value="{$invoiceData.invoice_id}">
                            <table align="center" width="60%" border="0" style="border:1px solid #CCCCCC;">
                            	...
                            	<tr height="26">
                                    ...
                                    <td align="left" colspan="2">Date of Order: {$invoiceData.invoice_generated_on|date_format}</td>
                                </tr>                                
                                <tr height="26">
                                    <td align="left">
                                	...
                                	<td align="left" colspan="2">
                                    	<table border="0" width="100%" align="left" cellpadding="2" cellspacing="0" class="invoice-main">
                                            ...
                                            <tr id='tr_del_charge_{$smarty.section.counter.index}'>
                                             	<td align="right" >{if $invoiceData.is_approved == '0' && $invoiceData.is_cancelled == '0'}<img src='../admin_images/delete_charge.jpg' id='del_charge_{$smarty.section.counter.index}' title='Delete' onclick='del_charge(this.id)'>{else}&nbsp;{/if}</td>
                                                <td align="right" >
                                            ...
                                            <td align="right" >{if $invoiceData.is_approved == '0' && $invoiceData.is_cancelled == '0'}<img  src='../admin_images/delete_charge.jpg' id='del_amnt_{$smarty.section.counter.index}' title='Delete' onclick='del_discount(this.id)'>{else}&nbsp;{/if}</td>
                                                <td align="right" >
                                            ...
                                            <tr>
                                			 <td colspan="3" align="center" id="approved_btn"><input type="button" name="Approve" value="Approve" id="approve" class="button"></td>
                               	 			...
                               	 			{elseif $invoiceData.is_approved=='1' && $invoiceData.is_cancelled!='1'}
                               	 			<tr>
                                			 ...
                                			 <input type="button" name="Canceled" value="Canceled" id="canceled" class="button" style="display: none;">
                               	 			...
                               	 			{elseif $invoiceData.is_cancelled=='1' && $invoiceData.is_approved=='0'}
                               	 			<tr>
