                                	...
                                	<td align="left" colspan="2">
                                    	<table border="0" width="100%" align="left" cellpadding="2" cellspacing="0" class="invoice-main">
                                            ...
                                            <tr id='tr_del_charge_{$smarty.section.counter.index}'>
                                             	<td align="right" >{if $invoiceData.is_approved == '0' && $invoiceData.is_cancelled == '0' && $invoiceData.is_paid == '0'}<img src='../admin_images/delete_charge.jpg' id='del_charge_{$smarty.section.counter.index}' title='Delete' onclick='del_charge(this.id)'>{else}&nbsp;{/if}</td>
                                                <td align="right" >
                                            ...
                                            <td align="right" >{if $invoiceData.is_approved == '0' && $invoiceData.is_cancelled == '0' && $invoiceData.is_paid == '0'}<img  src='../admin_images/delete_charge.jpg' id='del_amnt_{$smarty.section.counter.index}' title='Delete' onclick='del_discount(this.id)'>{else}&nbsp;{/if}</td>
                                                <td align="right" >
