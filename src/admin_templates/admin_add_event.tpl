		...
		<td width="100%" align="center">
			<form name="frm_add_event" id="frm_add_event" method="post" action="">
				...
				<table width="50%" border="0" cellspacing="1" cellpadding="5" align="center" class="header_bordercolor">
					...
					<tr class="tr_bgcolor">
						<td valign="top" width="30%"><span class="err">*</span> Event Start Date : </td>
						<td><input type="text" name="start_date" id="start_date" value="{$start_date}" class="look required" />
					...
					<tr class="tr_bgcolor">
						...
						<td><input type="text" name="end_date" id="end_date" value="{$end_date}" class="look required" />
                       <!-- <div class="list-err">{$end_date_err}</div>-->
                       <br /><span class="err" id="end_date_err">{$end_date_err}</span>
                       </td>
					</tr>
					<tr class="tr_bgcolor">
												<td class="text" valign="top">&nbsp;&nbsp;Start Time :</td>
												<td class="smalltext">
                    ...
                    <tr class="tr_bgcolor">
						...
						<td><input type="text" size="45" name="event_title" id="event_title" value="{$event_title}" class="look required" /> 
					...
					<tr class="tr_bgcolor">
						...
						<td><textarea name="event_desc" class="look required" style="width:250px;" >{$event_desc}</textarea> 
