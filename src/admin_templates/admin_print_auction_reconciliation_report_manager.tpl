							...
							<form name="listFrom" id="listForm" action="" method="post" >
								...
								<table align="center" width="60%" border="1" cellspacing="1" cellpadding="2" style="border-collapse:collapse;" bordercolor="#000000" >
									<tbody>
										...
										<tr class="tr_bgcolor" height="26">
											<td  class="printer"  colspan="2">Total sold but not paid by seller:</td >
										...
										<tr class="tr_bgcolor" height="26">
											<td  class="bold_text" colspan="2">Total unapproved:</td >
											<td colspan="3">&nbsp;<font style="font-size:12px; font-family:Arial;">{$total_unapproved}</font>&nbsp;</td>
										</tr>
										{if $total_yet_paid >0}
										...
										{section name=counter loop=$paidAuctionDetails}
											<tr class="{cycle values="odd_tr,even_tr"}">
												<td align="left" class="smalltext" width="20%">&nbsp;&nbsp;<img src="{$paidAuctionDetails[counter].image_path}" ><br/>
												...
												<td align="center" class="smalltext"><font style="font-size:12px; font-family:Arial;">{if $paidAuctionDetails[counter].soldamnt > 0}${$paidAuctionDetails[counter].soldamnt}{else}--{/if}</font></td>
												<td align="center" class="smalltext" ><font style="font-size:12px; font-family:Arial;">{if $paidAuctionDetails[counter].soldamnt > 0}${$paidAuctionDetails[counter].mpe_charge} + ${$paidAuctionDetails[counter].trans_charge}{else}--{/if}</font></td>
												<td align="center" class="smalltext"><font style="font-size:12px; font-family:Arial;">{if $paidAuctionDetails[counter].soldamnt > 0}${$paidAuctionDetails[counter].seller_owned}{else}--{/if}</font></td>
