									...
									<td align="center">
										<table align="center" width='70%' border="0" cellpadding="2" cellspacing="1" class="header_bordercolor">
                                                        	...
                                                        	<td align="center">
                                                            	<div id="existing_photos" style="width:680px; padding:10px; margin:0px; float:left;">
                                                                    {section name=counter loop=$posterImageRows}
                                                                        ...
                                                                        <div id="existing_{$countID}" style="float:left; width:110px;height:150px; padding:0px 2px 0 1px; margin:0px;"><img src="{$actualPath}/poster_photo/thumbnail/{$posterImageRows[counter].poster_thumb}"  />
                                            ...
                                            <tr class="tr_bgcolor">
												...
												<td class="smalltext">
                                                <input type="checkbox" name="is_percentage" value="1" {if $auctionRow[0].is_offer_price_percentage == 1} checked="checked" {/if} />
                                                &nbsp;Amount as a percentage</td>
											</tr>
											<tr class="tr_bgcolor">
