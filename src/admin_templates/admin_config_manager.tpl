									...
									<td align="center">
										<table align="center" width='70%' border="0" cellpadding="2" cellspacing="1" class="header_bordercolor">
											...
											<tr class="tr_bgcolor">
												...
												<td class="smalltext"><input type="text" name="peterEmail" value="{$peterEmail}" class="look"  style="width:250px;" /><br><span class="err">{$peterEmail_err}</span></td>
											</tr>
											<tr class="tr_bgcolor">
												<td class="bold_text" valign="top">Halley's Email :</td>
												<td class="smalltext"><input type="text" name="seanEmail" value="{$seanEmail}" class="look"  style="width:250px;" /><br><span class="err">{$seanEmail_err}</span></td>
											</tr>
											...
											<tr class="tr_bgcolor" style="display:none;">
											  ...
											  <tr class="header_bgcolor" height="24">
									           ...
									           <tr class="tr_bgcolor">
									            ...
									            <td class="smalltext"><textarea name="metaKeywords" rows="6" cols="85" class="look" >{$metaKeywords}</textarea></td>
									           </tr>
									           <tr class="tr_bgcolor">
									            <td class="bold_text" valign="top">Meta Keywords :</td>
									            <td class="smalltext"><textarea name="metaDescription" rows="6" cols="85" class="look">{$metaDescription}</textarea></td>
									           </tr>           
									           <tr class="tr_bgcolor">
									            <td class="bold_text" valign="top">Meta Tags :</td>
									            <td class="smalltext"><textarea name="metaTags" rows="6" cols="85" class="look">{$metaTags}</textarea></td>
									          </tr>
											<tr class="header_bgcolor" height="24">
...
<!--											</tr>-->
                                            ...
                                            <tr class="tr_bgcolor">
												...
												<td class="smalltext"><input type="text" name="sale_tax_ga" value="{$sale_tax_ga}" class="look" maxlength="5" style="width:50px;" />&nbsp;%<br /><span class="err">{$ga_sale_tax_err}</span></td>
											</tr>
                                            <tr class="tr_bgcolor">
												<td class="bold_text" valign="top">Sales Tax for North Carolina:</td>
												<td class="smalltext"><input type="text" name="sale_tax_nc" value="{$sale_tax_nc}" class="look" maxlength="5" style="width:50px;" />&nbsp;%<br /><span class="err">{$nc_sale_tax_err}</span></td>
											</tr>
											<tr class="header_bgcolor" height="24">
											...
											<tr class="tr_bgcolor">
												...
												<td class="smalltext"><input type="text" name="bannerTitle" value="{$bannerTitle}" class="look"  style="width:250px;" maxlength="50" /><br><span class="err">{$bannerTitle_err}</span></td>
											</tr>
											<tr class="tr_bgcolor">
												<td class="bold_text" valign="top">Banner Link :</td>
												<td class="smalltext"><input type="text" name="bannerLink" value="{$bannerLink}" class="look"  style="width:250px;" /><br><span class="err">{$bannerLink_err}</span></td>
											</tr>
											<tr class="header_bgcolor" height="24">
											...
											<tr class="tr_bgcolor">
												...
												<td class="smalltext"><input type="radio" name="shortType" value="1" {if $short_type=='1'} checked="checked" {/if}  />&nbsp;Auction Id
												<input type="radio" name="shortType" value="2" {if $short_type=='2'} checked="checked" {/if}   />&nbsp;Highest to Lowest
												</td>
											</tr>
