											...
											<tr id="tr_{$auctionRows[counter].auction_id}" class="{cycle values="odd_tr,even_tr"}">
                                                ...
                                                <td id="td_{$auctionRows[counter].auction_id}" align="center" class="smalltext">
													{if $auctionRows[counter].auction_is_approved == 0}
														<img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_active.gif" align="absmiddle" alt="Approve" border="0" onclick="javascript: approveAuction({$auctionRows[counter].auction_id}, 1, '{$smarty.request.search}', 'weekly');" title="Approve" class="changeStatus" />&nbsp;|&nbsp;<img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_inactive.gif" align="absmiddle" alt="Disapprove" border="0" onclick="javascript: approveAuction({$auctionRows[counter].auction_id}, 2, '{$smarty.request.search}', 'weekly');" title="Disapprove" class="changeStatus" />
                                                ...
                                                {*if $auctionRows[counter].auction_is_approved == '0'*}
                                                	<a href="{$adminActualPath}/admin_auction_manager.php?mode=edit_weekly&auction_id={$auctionRows[counter].auction_id}&encoded_string={$encoded_string}" class="view_link"><img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_edit.gif" align="absmiddle" alt="Update Poster" title="Update Poster" border="0" class="changeStatus" /></a>
                                                    <a href="#" class="view_link" onclick="javascript: deleteConfirmRecord('{$adminActualPath}/admin_auction_manager.php?mode=delete_auction&auction_id={$auctionRows[counter].auction_id}&auction_type=2&encoded_string={$encoded_string}', 'auction','{$auctionRows[counter].auction_id}'); return false;"><img src="{$smarty.const.CLOUD_STATIC_ADMIN}delete_image.png" align="absmiddle" alt="Delete Auction" title="Delete Auction" border="0" class="changeStatus" /></a>
                                                {*/if*}
                                                <a href="{$adminActualPath}/admin_auction_manager.php?mode=view_weekly&auction_id={$auctionRows[counter].auction_id}&encoded_string={$encoded_string}" class="view_link"><img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_open.gif" align="absmiddle" alt="Details" title="Details" border="0" class="changeStatus" /></a> 
                                                ...
                                                {if $search == 'selling' || $search == 'sold' || $auctionRows[counter].auction_is_approved == '1'}
												...
												{if $search == 'unpaid' && $auctionRows[counter].reopen_auction_id=='0'}
													 <a href="{$adminActualPath}/admin_auction_manager.php?mode=reopen_weekly&auction_id={$auctionRows[counter].auction_id}&encoded_string={$encoded_string}"><img src="{$smarty.const.CLOUD_STATIC_ADMIN}reopen_auction.jpg" align="absmiddle" alt="Reopen Auction" title="Reopen Auction" border="0" class="changeStatus" width="20px" /></a>
												...
												{if $search == 'selling' || $search == 'sold'}
                                                 <a href="{$adminActualPath}/admin_proxy_manager.php?auction_id={$auctionRows[counter].auction_id}&type={$search}&encoded_string={$encoded_string}" class="view_link"><img src="{$smarty.const.CLOUD_STATIC_ADMIN}proxy-bid-icon.png" align="absmiddle" title="Proxy Bids" width="20" height="16" border="0" /></a>
												
												{/if}
												{if ($search == 'selling' || $search == 'upcoming') && $auctionRows[counter].is_big=='1'}
