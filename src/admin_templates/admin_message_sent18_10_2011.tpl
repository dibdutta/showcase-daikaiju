										...
										{section name=counter loop=$messageRows}
											<tr class="{cycle values="odd_tr,even_tr"}">
												...
												<td align="center" class="bold_text">
													<a href="#" class="view_link" onclick="javascript: deleteConfirmRecord('{$adminActualPath}/admin_messages.php?mode=delete_sent_message&message_id={$messageRows[counter].message_id}&encoded_string={$encoded_string}', 'Message'); return false;"><img src="{$adminImagePath}/delete_image.png" align="absmiddle" alt="Delete Message" title="Delete Message" border="0" class="changeStatus" /></a>
												</td>
											</tr>
										{/section}
										<tr class="header_bgcolor" height="26">
