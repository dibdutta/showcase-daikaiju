									...
									<td align="center">
										<table align="center" width='70%' border="0" cellpadding="2" cellspacing="1" class="header_bordercolor">
                                            ...
                                            <tr class="tr_bgcolor">
                                                ...
                                                <td class="smalltext">
                                                    ...
                                                    {section name=counter loop=$eventRows}
                                                        {if $auctionRow[0].fk_event_id == $eventRows[counter].event_id} {$eventRows[counter].event_title} {/if}
                                                    {/section}
                                            ...
                                            <tr class="tr_bgcolor">
												...
												<td class="smalltext">${$auctionRow[0].auction_reserve_offer_price|number_format:2}<br /><span class="err">{$reserve_price_err}</span></td>
											</tr>
											{*<tr class="tr_bgcolor">
