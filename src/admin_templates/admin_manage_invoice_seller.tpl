                        ...
                        <input type="hidden" id="invoice_id" value="{$invoiceData.invoice_id}">
                            <table align="center" width="60%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #CCCCCC;">
								...
								<tr class="bgcolor" height="26" id="track_is_approved4">
                                    ...
                                    <td align="left">&nbsp;Amount:&nbsp;&nbsp;<input type="text" id="discount_amnt" name="charges" class="look" /> &nbsp;<img id="add_discount" src="{$smarty.const.CLOUD_STATIC_ADMIN}add_images.jpg"></td>
								</tr>
								...
								<tr class="bgcolor" height="26" id="track_is_approved2">
                                    ...
                                    <td align="left">&nbsp;Amount:&nbsp;&nbsp;<input type="text" id="charge_amnt" name="charge_amnt" class="look" />&nbsp;<img id="add_charge" src="{$smarty.const.CLOUD_STATIC_ADMIN}add_images.jpg"></td>
								</tr>
								
								{/if}
								<tr class="header_bgcolor" height="26">
									<td colspan="2" class="headertext"><b>&nbsp;Seller Reconcilation</b></td>
								</tr>
                            	<tr height="26">
                                    {*<td align="left">Invoice # 1245</td>*}
                                    <td align="left" colspan="1">&nbsp;Reconciliation Date: {$invoiceData.invoice_generated_on|date_format}</td>
                                	<td align="left" style="display:none;"  id="invoice_cancelled">Status:<font style="color:red;"> Cancelled</font></td>
                                	...
                                	<td align="left"  id="invoice_approved_on"><strong>Status: </strong><font style="color:black;">Approved</font></td>
                                	{/if}
                                	{if $invoiceData.is_approved == '0' && $invoiceData.is_cancelled == '0' && $invoiceData.is_paid == '0'}
                                	<td align="left"  id="invoice_not_approved_on"><strong>Status: </strong><font style="color:red;"> Not Approved</font></td>
                                	{/if}
                                	{if $invoiceData.is_approved == '1' && $invoiceData.is_cancelled == '1'}
                                	<td align="left"   id="invoice_cancelled"><strong>Status: </strong> <font style="color:red;">Cancelled</font></td>
                               		{/if}
                               		{if $invoiceData.is_approved == '1' && $invoiceData.is_cancelled == '0' && $invoiceData.is_paid == '1'}
                                	<td align="left"  id="invoice_approved_on"><strong>Status: </strong><font style="color:green;"> Paid</font></td>
                                	{/if}
                                	{if $invoiceData.is_approved == '0' && $invoiceData.is_cancelled == '0' && $invoiceData.is_paid == '1'}
                                	<td align="left"  id="invoice_approved_on"><strong>Status: </strong><font style="color:red;">Not Approved</font> </td>
                                	{/if}
                                </tr>                                
                                 <tr height="26">
