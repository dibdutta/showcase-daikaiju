					...
					{if $adminTracker==1}
                        <li><a href="#">MY ACCOUNT</a>
                            <ul>
								...
								<li><a href="{$smart.const.DOMAIN_PATH}/admin/admin_generate_sitemap.php">Generate Sitemap</a></li>
                                {php}}{/php}
                            </ul>
                        </li>
                        <li><a href="#">CMS</a>
						...
						<li><a href="#">Access Customer Information</a>
							<ul>
							  <li><a href="{$smarty.const.ADMIN_PAGE_LINK}/admin_access_cust_info.php?mode=seller">Customer Master Invoice</a></li>							  
							</ul>							
						</li>
						{/if}
                    </ul>
