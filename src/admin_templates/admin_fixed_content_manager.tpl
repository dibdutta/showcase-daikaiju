	...
	<tr>
		<td width="100%">
			<table width="100%" border="0" cellspacing="0" cellpadding="2">
				<tr>
					<td align="center">{if $smarty.const.FIXED_PAGE_CREATION == 1}<a href="{$adminActualPath}/admin_content_manager.php?mode=create_page" class="action_link"><strong>Create New Fixed Page</strong></a>{/if}{if $smarty.const.CUSTOM_PAGE_CREATION == 1}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="{$adminActualPath}/admin_content_manager.php?mode=create_custom_page" class="action_link"><strong>Add New Custom Page</strong></a>{/if}</td>
				</tr>
				{if $errorMessage<>""}
					<tr>
				...
				{if $total>0}
					<tr>
						<td align="center">
							<div style="width: 95%; text-align: right;"><a href="{$smarty.const.PHP_SELF}?type={$type}" class="new_link">&laquo; Back</a>{if $add_content_display == 1}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="{$adminActualPath}/admin_content_manager.php?mode=add_content&type={$type}&page_id={$page_id}&encoded_string={$encoded_string}" class="new_link">Add New Content &raquo;</a>{/if}</div>
							<form name="listFrom" id="listForm" action="" method="post" >
								...
								<table align="center" width="96%" border="0" cellspacing="1" cellpadding="2" class="header_bordercolor" >
									<tr class="header_bgcolor" height="26">
										...
										<td align="center" class="headertext" width="10%">{$sslTXT}</td >
									...
									{section name=counter loop=$pageID}
										<tr class="{cycle values="odd_tr,even_tr"}">
											...
											<td align="center" class="smalltext" id="changeSSLStatusPortion_{$pageID[counter]}">
												{if ($smarty.const.MULTIUSER_ADMIN == 1 and $smarty.session.superAdmin == 1) or $smarty.const.MULTIUSER_ADMIN == 0}
													{if $sslStatus[counter] == "Active"}
														<img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_lock.gif" align="absmiddle" alt="Active" border="0" onclick="javascript: changeSSLStatus('ssl_custom', {$pageID[counter]}, 'changeSSLStatusPortion_{$pageID[counter]}');" title="Change Status" class="changeStatus" />
													{else}
														<img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_unlock.gif" align="absmiddle" alt="Active" border="0" onclick="javascript: changeSSLStatus('ssl_custom', {$pageID[counter]}, 'changeSSLStatusPortion_{$pageID[counter]}');" title="Change Status" class="changeStatus" />
													{/if}												
												{else}
													{if $sslStatus[counter] == "Active"}
														{if $smarty.const.MULTIUSER_ADMIN == 1 and  ($permission[counter] == "Edit" or $permission[counter] == "Full")}
															<img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_lock.gif" align="absmiddle" alt="Active" border="0" onclick="javascript: changeSSLStatus('ssl_custom', {$pageID[counter]}, 'changeSSLStatusPortion_{$pageID[counter]}');" title="Change Status" class="changeStatus" />
														{else}
															<img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_lock.gif" align="absmiddle" alt="Active" border="0" title="Don't have the permission" class="changeStatus" />
														{/if}													
													{else}
														{if $smarty.const.MULTIUSER_ADMIN == 1 and  ($permission[counter] == "Edit" or $permission[counter] == "Full")}
															<img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_unlock.gif" align="absmiddle" alt="Active" border="0" onclick="javascript: changeSSLStatus('ssl_custom', {$pageID[counter]}, 'changeSSLStatusPortion_{$pageID[counter]}');" title="Change Status" class="changeStatus" />
														{else}
															<img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_unlock.gif" align="absmiddle" alt="Active" border="0" title="Don't have the permission" class="changeStatus" />
														{/if}			
													{/if}
												{/if}
											</td>
											<td align="center" class="bold_text">
												{if ($smarty.const.MULTIUSER_ADMIN == 1 and $smarty.session.superAdmin == 1) or $smarty.const.MULTIUSER_ADMIN == 0}
													...
													{if ($smarty.const.MULTIUSER_ADMIN == 1 and $smarty.session.superAdmin == 1) or $smarty.const.MULTIUSER_ADMIN == 0}
														&nbsp;|&nbsp;<a href="#" class="view_link" onclick="javascript: deleteConfirmRecord('{$adminActualPath}/admin_content_manager.php?mode=delete_content&page_content_id={$pageID[counter]}&type=custom&encoded_string={$encoded_string}', 'content'); return false;"><img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_delete.gif" align="absmiddle" alt="Delete Content" title="Delete Content" border="0" class="changeStatus" /></a>&nbsp;|&nbsp;<a href="#" class="view_link" onclick="javascript: deleteConfirmRecord('{$adminActualPath}/admin_content_manager.php?mode=delete_page&page_content_id={$pageID[counter]}&type=custom', 'page'); return false;"><img src="{$smarty.const.CLOUD_STATIC_ADMIN}delete_image.png" align="absmiddle" alt="Delete Page" title="Delete Page" border="0" class="changeStatus" /></a>
													{/if}
												{else}
													{if ($smarty.const.MULTIUSER_ADMIN == 1 and  ($permission[counter] == "Edit" or $permission[counter] == "Full"))}
														<a href="{$adminActualPath}/admin_content_manager.php?mode=edit_content&type={$type}&page_content_id={$pageID[counter]}&encoded_string={$encoded_string}" class="view_link"><img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_edit.gif" align="absmiddle" alt="Update Content" title="Update Content" border="0" class="changeStatus" /></a>
													{else}
														<img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_edit.gif" align="absmiddle" alt="Update Content" title="Don't have the permission" border="0" class="changeStatus" />
													{/if}
													{if ($smarty.const.MULTIUSER_ADMIN == 1 and ($permission[counter] == "Delete" or $permission[counter] == "Full"))}	
														&nbsp;|&nbsp;<a href="#" class="view_link" onclick="javascript: deleteConfirmRecord('{$adminActualPath}/admin_content_manager.php?mode=delete_content&page_content_id={$pageID[counter]}&type=custom&encoded_string={$encoded_string}', 'content'); return false;"><img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_delete.gif" align="absmiddle" alt="Delete Content" title="Delete Content" border="0" class="changeStatus" /></a>&nbsp;|&nbsp;<a href="#" class="view_link" onclick="javascript: deleteConfirmRecord('{$adminActualPath}/admin_content_manager.php?mode=delete_page&page_content_id={$pageID[counter]}&type=custom', 'page'); return false;"><img src="{$smarty.const.CLOUD_STATIC_ADMIN}delete_image.png" align="absmiddle" alt="Delete Page" title="Delete Page" border="0" class="changeStatus" /></a>
													{else}
														&nbsp;|&nbsp;<img src="{$smarty.const.CLOUD_STATIC_ADMIN}icon_delete.gif" align="absmiddle" alt="Delete Content" title="Don't have the permission" border="0" class="changeStatus" />&nbsp;|&nbsp;<img src="{$smarty.const.CLOUD_STATIC_ADMIN}delete_image.png" align="absmiddle" alt="Delete Page" title="Don't have the permission" border="0" class="changeStatus" />
													{/if}	
												{/if}
											</td>
										</tr>
									...
									<tr class="header_bgcolor" height="26">
										...
										<td align="left" class="headertext" {if ($smarty.const.MULTILINGUAL == 1 and $type == "custom") or ($smarty.const.MULTIUSER_ADMIN == 1 and $smarty.session.superAdmin == 1)} colspan="3"{else} colspan="3"{/if}>{$pageCounterTXT}</td>
										...
										<td class="smalltext">
											...
											<select name="mode" class="look" onchange="javascript: this.form.submit();" >
												...
												{if ($smarty.const.MULTIUSER_ADMIN == 1 and $smarty.session.superAdmin == 1) or $smarty.const.MULTIUSER_ADMIN == 0}
													...
													<option value="delete_all_content">Delete Page Content</option>
