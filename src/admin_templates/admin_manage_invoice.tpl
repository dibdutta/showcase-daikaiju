    ...
    <tr>
        <td align="center" >
            <form name="listFrom" id="listForm" action="" method="post">
				...
				<input type="hidden" id="auction_id" value="{$smarty.request.auction_id}">
                <table align="center" width="60%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #CCCCCC;">
                    {if  $invoiceData.is_cancelled == '0' && $invoiceData.is_paid == '0'}
					...
					{if $invoiceData.is_paid=='1'} 
						<tr height="26">                                
							<td align="left" colspan="2">&nbsp;Date paid: {$invoiceData.paid_on|date_format}</td> 
						</tr> 
					{/if} 
                    <tr height="26">
                        <td align="left">
                            ...
                            <table border="0" width="100%" align="left" cellpadding="2" cellspacing="0" class="invoice-main">
                                ...
                                {assign var="seller_username" value= '' }
									...
									{elseif $chk_item_type=='2'}
										{if $seller_username !=$invoiceData.auction_details[counter].seller_username}
											...
											{/if}
											<tr><td colspan="3" class="billbrdr"><b>Auction :</b> {$invoiceData.auction_details[counter].seller_username}</td></tr>
                                ...
                                {section name=counter loop=$invoiceData.additional_charges}
                                    <tr id='tr_del_charge_{$smarty.section.counter.index}'>
                                        <td align="right" >{if  $invoiceData.is_cancelled == '0' && $invoiceData.is_paid == '0'}
                                            &nbsp;
                                ...
                                <tr>
                                    ...
                                    <td align="left" id="new_total_amnt">{if $invoiceData.additional_charges =='' && $invoiceData.discounts==''}${$subTotal+$ship_new_chrg}.000{else}${$invoiceData.total_amount}{/if}</td>
