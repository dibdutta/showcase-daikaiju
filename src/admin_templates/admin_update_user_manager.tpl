									...
									<form action="" method="post" name="updateUser" id="updateUser">
										...
										<table border="0" cellpadding="2" cellspacing="1" class="header_bordercolor" width="100%">
											...
											<tr class="tr_bgcolor">
												...
												<td valign="top"><input type="text" class="look" name="user_name" value="{$user_name}" maxlength="16" size="32" autocomplete="off" readonly="readonly" /><br><span class="err">{$user_name_err}</span></td>
											</tr>
											<tr class="tr_bgcolor">
											...
											<tr class="tr_bgcolor">
												<td align="center" class="bold_text" colspan=2><input type="submit" name="submit" class="button" value="Change Profile" >&nbsp;&nbsp;&nbsp;<input type="button" name="cancel" value="Cancel" class="button" onclick="javascript: location.href='{$smarty.const.PHP_SELF}'; " /></td>
											</tr>
										</table>
									</form>
								</td>
