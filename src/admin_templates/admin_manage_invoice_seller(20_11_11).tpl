                        ...
                        <input type="hidden" id="invoice_id" value="{$invoiceData.invoice_id}">
                            <table align="center" width="60%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #CCCCCC;">
								...
								<tr class="header_bgcolor" height="26" id="track_is_approved3">
									<td colspan="2" class="headertext"><b>&nbsp;Add Discounts</b></td>
								</tr>
								...
								<tr class="header_bgcolor" height="26">
									<td colspan="2" class="headertext"><b>&nbsp;Seller Reconciliation</b></td>
								</tr>
                            	<tr height="26">
                                ...
                                <tr>
                                	<td align="left" colspan="2">
                                    	<table border="0" width="100%" align="left" cellpadding="2" cellspacing="0" class="invoice-main">
                                            ...
                                            <td align="right" >&nbsp;{if $invoiceData.is_approved == '0' && $invoiceData.is_cancelled == '0' }
                                           {if $invoiceData.discounts[counter].description!='Marchant Fee' || $invoiceData.discounts[counter].description!='MPE Charge' || $invoiceData.discounts[counter].description!='Transaction charge'}
                                           	<img src='../admin_images/del_ind.jpg' style="display:none;" class="del_img"> 
                                            <img  src='../admin_images/delete_charge.jpg' id='del_amnt_{$smarty.section.counter.index}'class="del_ind" title='Delete' onclick='del_discount(this.id)'>{/if}{else}&nbsp;{/if}</td>
                                                <td align="right" >
