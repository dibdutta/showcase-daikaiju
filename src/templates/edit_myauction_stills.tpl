            ...
            <div id="inner-left-container">
                ...
                <div class="dashboard-main">
					...
					<form name="posterUpload" id="posterUpload" action="" method="post" enctype="multipart/form-data">
						<input type="hidden" name="mode" value="update_stills" />
						...
						<input type="hidden" name="poster_size"  value="34" />
                                <div class="formarea-listing">   
                                     ...
                                     <table width="100%" cellpadding="0" cellspacing="0" border="0" class="listbox">
                                        ...
                                        <tr>
                                            <td colspan="2" valign="top"><label>Description<span class="red-star">*</span></label>
                                                <p style="font-size:11px; margin:0px; padding:0px; line-height:40px;">please give a detailed description of your item including any restoration / backing</p></td>
...
<p style="font-size:11px; margin:0px; padding:0px; line-height:40px;">please give a detailed description of your item including any restoration / backing</p>{*</div>*}
                                        ...
                                        <tr>
											...
											<div id="textDiv" style="top:10px;width:370px;height:100px;position:relative;">
  												<textarea id="textBox" class="bigfield" name="auction_note" style="width:360px;height:90px;left:0px;top:0px;position:absolute;padding:0px 0px 0px 0px;">{$auctionRow[0].auction_note}</textarea>
  												<div id="handleRight" style="height:95px;position:absolute;left:95px;top:0px;"></div>
  												<div id="handleCorner" style="position:absolute;cursor:se-resize;top:87px;left:357px;"></div>
