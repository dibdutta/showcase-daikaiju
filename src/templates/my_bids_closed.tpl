...
<style type="text/css">.div {position:absolute;  left: 375px; min-width:120px; list-style-type:none; visibility:hidden;background-color:#006691;color:white; z-index:50;margin-left:80px;}</style>
                    ...
                    <div class="dashboard-main" style="margin-left:0;">
                        ...
                        <div class="light-grey-bg-inner">
                            ...
                            <div class="right-submenu">
                                <span class="goto-span"><strong>ITEMS I HAVE:</strong></span>
                                <ul class="menu">
                             ...
                             {section name=counter loop=$bidDetails}
                                    ...
                                    <td colspan="4">
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                ...
                                                <th width="20%" class="text bold">Bid Amount/Proxy Bid</th>
                                            </tr>
                                            ...
                                            {if ($bidDetails[counter].bids[bid_count].bid_is_won=='1') && $bidDetails[counter].highest_bid <= $bidDetails[counter].bids[bid_count].bid_amount && $bidDetails[counter].auction_is_sold <>'2'}
                                                ...
                                                {if $bidDetails[counter].highest_bid > $bidDetails[counter].bids[bid_count].bid_amount}
                                                   <tr class="red">
                                                    ...
                                                    <td class="text">{$bidDetails[counter].bids[bid_count].bid_time|date_format:"%I:%M:00 %p"} EDT</td>
                                                    <td class="text">{*{$bidDetails[counter].bids[bid_count].bid_time|date_format:"%A"} &nbsp;&nbsp;*}{$bidDetails[counter].bids[bid_count].post_date}</td>
                                                    <td class="text">{if $bidDetails[counter].proxy_amnt > $bidDetails[counter].bids[bid_count].bid_amount}${$bidDetails[counter].proxy_amnt|number_format:2}{else}${$bidDetails[counter].bids[bid_count].bid_amount|number_format:2}{/if}
                                                    {if $bidDetails[counter].auction_is_sold=='0'}&nbsp; (Unsold) {/if}
                                                    {if $bidDetails[counter].auction_is_sold!='0' && $bidDetails[counter].highest_bid==$bidDetails[counter].bids[bid_count].bid_amount && $bidDetails[counter].bids[bid_count].is_proxy=='0'}&nbsp; (Outbid) {/if}
                                                    </td>
                                                    </tr>
                                                 {/if}
                                                 {if $bidDetails[counter].highest_bid == $bidDetails[counter].bids[bid_count].bid_amount && $bidDetails[counter].bids[bid_count].bid_is_won=='0'}
                                                 <tr class="red">
                                                    <td style="border-left:1px solid #DFDFDF;">
                                                    &nbsp;&nbsp;<img src="{$smarty.const.CLOUD_STATIC}losing-bid-img.png" border="0" title="losing" />
                                                    </td>
                                ...
                                <tr>
                                    <td style="width:130px;" valign="top">
                                        ...
                                        <div id="gallery_{$smarty.section.counter.index}">
                                        <table align="center"><tbody><tr><td align="left" valign="middle" style="border:none;">
                                                <div class="buylisttb">
                                       <div><img  class="image-brdr" src="{$bidDetails[counter].image_path}" border="0"  border="0" onclick="redirect_poster_details({$bidDetails[counter].auction_id}, 0, 1);" style="cursor:pointer;" /></div></div>
                                       </td></tr></tbody></table>
                                         </div>
                                       </div>
                                    </td>
                                    <td style="width:129px;" valign="top" class="text">
                                    <span style="cursor:pointer;" onclick="redirect_poster_details({$bidDetails[counter].auction_id}, 0, 1);"> &nbsp;&nbsp;{$bidDetails[counter].poster_title}{*$bidDetails[counter].poster_sku*}</span><br/><br/>
                                    ...
                                    <p >Number of Bids: {$bidDetails[counter].count_bid}</p><br/>
