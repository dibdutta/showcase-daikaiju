                            ...
                            {if $total > 0}
                                ...
                                <div style="border-bottom:1px solid #e8e8e8; padding:16px 0 14px 0; overflow:hidden;">
                                    ...
                                    <h2 style="margin:0 0 4px 0; font-size:15px; line-height:1.3;">
                                        <a href="{$actualPath}/blog/{$p.slug}" style="color:#bd1a21; text-decoration:none;">{$p.title|escape}</a>
                                    </h2>
                                    ...
                                    <a href="{$actualPath}/blog/{$p.slug}" style="font-size:11px; color:#bd1a21; font-weight:bold;">Read More &raquo;</a>
                                    <div class="clear"></div>
                                </div>
                                {/foreach}
