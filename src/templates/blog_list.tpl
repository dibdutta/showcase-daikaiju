            ...
            <div id="inner-left-container">
                <div class="innerpage-container-main">
                    ...
                    {if $total > 0}
                        ...
                        <div style="border-bottom:1px solid #e0e0e0; padding:16px 0 14px 0; overflow:hidden;">
                            {if $p.featured_image != ""}
                                <a href="{$smarty.const.DOMAIN_PATH}/blog.php?slug={$p.slug}">
                                    <img src="{$smarty.const.DOMAIN_PATH}/blog_images/{$p.featured_image}" alt="{$p.title|escape}" style="width:180px; height:120px; object-fit:cover; float:left; margin:0 14px 6px 0; border:1px solid #ddd;" />
                                </a>
                            {/if}
