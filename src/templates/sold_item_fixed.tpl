                      ...
                      {if $total > 0}
							...
							<div class="left-area">
									...
									{if $smarty.request.mode=='search_sold_fixed'}
										<li class="grid"><a href="sold_item.php?view_mode=gallery&mode=search_sold_fixed&search_sold={$smarty.request.search_sold|urlencode}"></a> </li>
									{else}
                                        <li class="grid"><a href="sold_item.php?view_mode=gallery&mode=fixed"></a> </li>
									{/if}                                        
                                    </ul>
                            </div>
