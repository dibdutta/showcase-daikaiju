                      ...
                      {if $total > 0}
							...
							<div class="left-area_auction" style="width:150px;">
									...
									{if $smarty.request.mode=='search_sold_stills'}
										<li class="grid"><a href="sold_item.php?view_mode=grid&mode=search_sold_stills&search_sold={$smarty.request.search_sold|urlencode}">&nbsp;</a> </li>
									{else}
                                        <li class="grid"><a href="sold_item.php?view_mode=grid&mode=stills">&nbsp;</a> </li>
									{/if}	
