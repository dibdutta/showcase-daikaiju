                        ...
                        <form name="listFrom" id="listForm" action="my_want_list" method="post">
                        	...
                        	<table width="100%" cellpadding="3" cellspacing="1" align="left" border="0" >
                                ...
                                <tr>
                                    ...
                                    <td class="tac"><a href="javascript:void(0)" class="view_link" onclick="javascript: deleteConfirmRecord('{$actualPath}/my_want_list?mode=delete_want&wantlist_id={$wantlist[counter].wantlist_id}&encoded_string={$encoded_string}', 'wantlist'); return false;"><img src="{$smarty.const.CLOUD_STATIC}delete-icon.png" width="24" height="24" border="0" alt="Delete" title="Delete" /></a>
                                    	&nbsp;<a href="{$actualPath}/my_want_list?mode=edit_want&wantlist_id={$wantlist[counter].wantlist_id}&encoded_string={$encoded_string}" class="view_link" ><img src="{$smarty.const.CLOUD_STATIC}edit-icon2.png" width="24" height="24" border="0" alt="Edit" title="Edit" /></a>
                                    </td>
                                </tr>
                                {/section}
                                <!--<tr>
