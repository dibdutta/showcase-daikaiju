                        ...
                        {section name=counter loop=$auctionRows}
                            <tr>
                                ...
                                <td width="21%" valign="top">
                                	<p class="poster-txt" style="cursor:pointer;" onclick="redirect_poster_details({$auctionRows[counter].auction_id}, 1);">{$auctionRows[counter].poster_title}&nbsp;{*$auctionRows[counter].poster_sku*}</p>
									<p class="poster-txt">
                                        ...
                                        <tr>
											...
											{if $offers[offerCounter].cntr_offer_id > 0}
												{if $offers[offerCounter].cntr_ofr_offer_is_accepted == 0}
													<div style="float:left; padding-right:10px"><input type="button" value="Accept" class="track-btn-small" onclick="acceptOfferModified({$auctionRows[counter].auction_id}, {$offers[offerCounter].offer_id}, {$offers[offerCounter].cntr_offer_id}, 'buyer');" /></div>
													<div><input type="button" value="Reject" class="track-btn-small" onclick="rejectOfferModified({$offers[offerCounter].offer_id}, {$offers[offerCounter].cntr_offer_id}, 'buyer');" /></div>
