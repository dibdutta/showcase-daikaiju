...
$(document).ready(function(){
	...
	setInterval(function() { refreshOutgoingOffers(offset,toshow,orderBy,orderType); }, 50000);
})
</script>
<script type="text/javascript">
                                ...
                                <td colspan="5">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        ...
                                        <tr>
											...
											<td id="cntr_ofr_status_{$offers[offerCounter].offer_id}"  style="text-align:center;" class="text"><blockquote>
											  <p>
											    {if $offers[offerCounter].cntr_offer_id > 0}
											 ...
											 <div style="margin:0 auto;">
											        ...
											        <input type="button" value="Accept" class="track-btn-small" style="margin: 5px 2px;" onclick="acceptOffer({$auctionRows[counter].auction_id}, {$offers[offerCounter].offer_id}, {$offers[offerCounter].cntr_offer_id}, 'buyer',{$offset},{$toshow});" />
											  </div>
													<div style="margin:0 auto;">
													  <input type="button" value="Reject" style="margin: 0 2px 5px 2px;"  class="track-btn-small" onclick="rejectOffer({$offers[offerCounter].offer_id}, {$offers[offerCounter].cntr_offer_id}, 'buyer',{$offset},{$toshow});" />
												        
													</div>
													<blockquote>
													  <p>												      {elseif $offers[offerCounter].cntr_ofr_offer_is_accepted == 1}
													    Accepted
