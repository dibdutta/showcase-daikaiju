...
<div id="inner-right-container">
             ...
             <div style="width:214px; height:27px;border:1px solid #cecfd0; float:left; margin-bottom:10px; background-color:#fff;">
				<input type="hidden" name="llr" value="bwdjsljab">
				<input type="hidden" name="m" value="1109563576001">
				<input type="hidden" name="p" value="oi">
				<input type="text" name="ea" size="20" value="" style="float:left\9;"> <input name="" type="button" style="float:right\9;" onclick="formSubmit();" />
                </div>
             ...
             <div class="dashblock mr24" style="width:100%;">
                 ...
                 <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:10px; color:blue;">
                     {if $featuredArticles}
                         ...
                         <tr>
                             <td width="100%"><b><i><u><a href="{$actualPath}/blog.php?slug={$article.slug}" style="color:blue; font-size:13px;">{$article.title}</a></u></i></b></td>
                         </tr>
                         {/foreach}
                     {else}
