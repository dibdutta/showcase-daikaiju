                        ...
                        <div class="light-grey-bg-inner">
                            ...
                            <div class="right-submenu">
                                ...
                                <ul class="menu">
									...
									<li><img class="imgprpty" src="{$smarty.const.CLOUD_STATIC}winning-bid-img.png" width="13" height="14" border="0" /><a class="green" href="{$actualPath}/my_bid?mode=winning">Winning</a>]</li>
                                    <li>&nbsp;[</li>
									<li><img class="imgprpty" src="{$smarty.const.CLOUD_STATIC}losing-bid-img.png" width="13" height="14" border="0"  /><a class="red" href="{$actualPath}/my_bid?mode=losing">Losing</a>]</li>
                                    <li>&nbsp;[<a href="{$actualPath}/my_bid">All</a>]</li>
                                </ul>	
                            </div>
                            </div>
                            <div class="clear"></div>
