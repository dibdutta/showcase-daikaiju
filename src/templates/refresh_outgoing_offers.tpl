                    ...
                    <tr>
                        ...
                        {if $offers[offerCounter].cntr_offer_id > 0}
                            {if $offers[offerCounter].cntr_ofr_offer_is_accepted == 0}
                                <div style="margin:0 auto;"><input type="button" value="Accept" class="track-btn-small" style="margin: 5px 2px;" onclick="acceptOffer({$auctionRows[counter].auction_id}, {$offers[offerCounter].offer_id}, {$offers[offerCounter].cntr_offer_id}, 'buyer',{$offset},{$toshow});" /></div>
                                <div style="margin:0 auto;"><input type="button" value="Reject" class="track-btn-small" style="margin: 0 2px 5px 2px;" onclick="rejectOffer({$offers[offerCounter].offer_id}, {$offers[offerCounter].cntr_offer_id}, 'buyer',{$offset},{$toshow});" /></div>
