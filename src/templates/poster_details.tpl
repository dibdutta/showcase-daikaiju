...
var _sessUID = '{/literal}{$smarty.session.sessUserID}{literal}';
function redirect_to_cart(auction_id, user_id) {
    if (_sessUID == '') {
        showLogIn();
    } else if (user_id == _sessUID) {
...
<!--                        <h2>{$auctionDetails[0].poster_title}&nbsp;{*if $smarty.session.sessUserID <> ""}(#{$auctionDetails[0].poster_sku}){/if*}</h2>-->
						...
						<span style="margin-left:40px; color:#CC0033;">Click image to enlarge</span>
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tac"><tbody><tr><td align="left" valign="middle" style="border:none;">
                                <div class="buygrid_big">
                                    ...
                                    {*<input type="button" value="Click to Enlarge" class="track-btn" {if $smarty.session.sessUserID != ""}  onclick="javascript:window.open('{$actualPath}/auction_images_large?mode=auction_images_large&id={$auctionDetails[0].poster_id}','mywindow','menubar=1,resizable=1,width={$width+100},height={$height+100},scrollbars=yes')" {else} onclick="highlight()"{/if} />*}
                        ...
                        <div class="poster-det-cntnt" style="width:330px;">
                          ...
                          <tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" align="right" style="padding-right:20px;">
                                ...
                                {if $auctionDetails[0].auction_is_sold=='0'}
                                    ...
                                    {*if $auctionDetails[0].is_reopened=='0'*}
                                    {if $auctionDetails[0].auction_reserve_offer_price > 0}
                                        <tr>
                                            {*if $auctionDetails[0].auction_reserve_offer_price > 0 && $auctionDetails[0].is_offer_price_percentage == 1}
                                            <td valign="top" class="text"><b>Minimum :</b> ${math|number_format:2 equation="(( x *  y) / 100 )" x=$auctionDetails[0].auction_asked_price y=$auctionDetails[0].auction_reserve_offer_price}</td>
                                            {elseif $auctionDetails[0].auction_reserve_offer_price > 0 && $auctionDetails[0].is_offer_price_percentage != 1}
                                            <td valign="top" class="text"><b>Minimum :</b> ${$auctionDetails[0].auction_reserve_offer_price|number_format:2}</td>
                                            {/if*}
			...
			test_enter(auc_id);
                                            ...
                                            <td valign="top"><input type="button" id="offer_bttn_{$auctionDetails[0].auction_id}" value="MAKE OFFER" onclick="postOffer({$auctionDetails[0].auction_id}, '{$auctionDetails[0].fk_user_id}','{$auctionDetails[0].auction_asked_price}');"  class="bidnow-btn makeoffer" style="margin:1px 0 0 0;" /></td>
        								</tr>
                                        </table>
                                        </div>
                                        </td>
                                ...
                                <tr>
                                    <td valign="top" class="text" colspan="3"><div class="auction-row"><div class="buy-text bold">Sold for:</div><div class="buy-text"><span class="offer_buyprice">${$auctionDetails[0].soldamnt|number_format:2}</span></div><div class="buy-text" ><b class="BigFont" >{$auctionDetails[0].count_offer} Offers </b></div></div></td
                                >
								</tr>
                                ...
                                {/if}
                                <tr>
                                    <td valign="top" class="text" colspan="3"><div class="auction-row"><div class="buy-text bold"><span class="SoldDirect">Sold by direct buy now.</span></div></div>
