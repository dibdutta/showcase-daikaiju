            ...
            <div id="inner-left-container">
				...
				<div id="tabbed-inner-nav">
                    <div class="tabbed-inner-nav-left">
                        <ul class="menu">
                            <li {if $smarty.request.mode == 'outgoing_counters'}class="active"{/if}><a href="{$actualPath}/offers?mode=outgoing_counters"><span>Recent Outgoing Counters</span></a></li>
                            <li {if $smarty.request.mode == 'archived_outgoing_counters'} class="active"{/if}><a href="{$actualPath}/offers?mode=archived_outgoing_counters"><span>Archived Outgoing Counters</span></a></li>
                                ...
                                <td width="18%" valign="top">
									<div id="gallery_{$smarty.section.counter.index}" class="posterdetails">
                                     <table align="center"><tbody><tr><td align="left" valign="top" style="border:none; vertical-align:top;">
                                       ...
                                       <div class="shadow-bringer shadow"><img  class="image-brdr" src="{$auctionRows[counter].image_path}" border="0"  border="0" onclick="redirect_poster_details({$auctionRows[counter].auction_id}, 1);" style="cursor:pointer;" /></div></div>
                                        </td></tr></tbody></table>
									</div>
                                </td>
                                ...
                                <td colspan="4">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            ...
                                            <th width="13%" class="text bold">Counter Offer</td>
                                            <th width="30%" class="text bold">Counter Offer's Status</td>
                                        ...
                                        <tr>
											...
											{else}
												...
												<!--<div style="float:left; padding-right:20px;">$<input type="text" id="cntr_amt_{$offers[offerCounter].offer_id}" class="inner-txtfld" maxlength="7"  /> .00</div><div><input type="button" value="Counter Offer" class="track-btn-small" onclick="makeCounterOffer({$auctionRows[counter].auction_id}, {$offers[offerCounter].offer_id}, $('#cntr_amt_'+{$offers[offerCounter].offer_id}).val(),{$offset},{$toshow});" /></div>-->
												    --
												{else}
													--
												{/if}
