...
{if $total > 0}
    ...
    {section name=counter loop=$auctionRows}
        <tr>
            ...
            <td width="27%" valign="top"><p class="poster-txt">{$auctionRows[counter].poster_desc}</p></td>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        ...
                        {elseif $offers[offerCounter].offer_is_accepted != 2}
                            ...
                            <div style="width:135px; margin:0 auto;"><div class="fll" style="width:10px;">$</div><input type="text" id="cntr_amt_{$offers[offerCounter].offer_id}" class="inner-txtfld" style="width:107px; height:15px; margin-left:5px;"  maxlength="7" /><!-- .00--></div><div><input type="button" value="Counter Offer" class="track-btn-small" style="margin: 5px 2px 5px 16px" onclick="makeCounterOffer({$auctionRows[counter].auction_id}, {$offers[offerCounter].offer_id}, $('#cntr_amt_'+{$offers[offerCounter].offer_id}).val(),{$offset},{$toshow});" /></div>
                            {else}
                                --
                            {/if}
                        {/if}
