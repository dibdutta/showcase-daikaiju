            ...
            <div id="inner-left-container">
                ...
                <div class="innerpage-container-main">
                        ...
                        <div class="black-midrept">
                            <span class="white-txt"><strong>Edit Monthly Auction</strong></span>
                                ...
                                <div class="formarea-listing">  
                                    <span>Fields marked <span class="mandatory">*</span> are mandatory</span>
                                     <table width="100%" cellpadding="0" cellspacing="0" border="0" class="listbox" >
                                        ...
                                        <tr>
                                        <td colspan="3" valign="top"><label>Event month<span class="red-star">*</span></label></td>
                                    	</tr>
                                    	<tr>
                                    	<td valign="top" colspan="3">
                                            ...
                                            {section name=counter loop=$eventRows}                                                        
                                                <input type="hidden" name="event_month" value="{$eventRows[counter].event_id}">
                                                <input name="auction_month_val" value="{$eventRows[counter].event_title}" class="bigfield required" readonly="readonly"  style="width:190px;height:20px;" />
                                            {/section}
                                            {else}
                                            ...
                                            <div class="disp-err">{$event_month_err}</div>
                                            </td>
                                    	</tr>
                                        <tr>
                                            <td colspan="3" width="420px" valign="top"><label>Description<span class="red-star">*</span></label></td>
...
<p style="font-size:11px; margin:0px; padding:0px; line-height:40px;">please give a detailed description of your item including any restoration / backing</p>{*</div>*}
										
                                            <!--<div style="float:left; width:420px; padding:0px; margin:0px; display:block;">
...
<div class="disp-err" style="position:absolute;">{$poster_desc_err}</div>
<br clear="all" />
...
<!--                                            <td valign="top">-->
<!--                                            {if $auctionRow[0].auction_is_approved=='1'}-->
<!--                                                <input type="text" name="display_end_time" style="width:75px;" value="{$auctionRow[0].auction_end_hour} : {$auctionRow[0].auction_end_min} {$auctionRow[0].auction_end_am_pm|upper}" class="bigfield required" readonly="readonly" />-->
...
<!--                                        </tr> -->
                                        <tr>
                                            ...
                                            <td valign="top"><label>Reserve Price</label></td>
                                        </tr>
                                        <tr>
                                            <td valign="top"><div class="text-price">$</div><div class="txtboxprice"><input type="text" name="asked_price" value="{$auctionRow[0].auction_asked_price}" {if $auctionRow[0].auction_is_approved!='0'} readonly {/if} class="formlisting-txtfield-price required number" /></div><div class="text-price">.00</div><div class="list-err">{$asked_price_err}</div></td>
                                            <td valign="top"><div class="text-price">$</div><div class="txtboxprice"><input type="text" name="reserve_price" value="{$auctionRow[0].auction_reserve_offer_price}" {if $auctionRow[0].auction_is_approved!='0' }readonly {/if} class="formlisting-txtfield-price" /></div><div class="text-price">.00</div><div class="list-err">{$reserve_price_err}</div></td>
                                            <td>&nbsp;</td>
                                        </tr>
                                         <tr>
                                        ...
                                        <tr>
                                            ...
                                            <div id="existing_photos" style="width:100%; padding:10px; margin:0px; float:left;">
                                                {section name=counter loop=$posterImageRows}
                                                    ...
                                                    <br />{if $auctionRow[0].auction_is_approved=='0'}<img src="{$smarty.const.CLOUD_STATIC}delete-icon.png" onclick="deletePhoto('existing_{$countID}', '{$posterImageRows[counter].poster_thumb}', 'existing')" />{/if}
                                        ...
                                        <tr>
                                            <td align="center" valign="top" colspan="3">
                                                ...
                                                <div id="browse" style="padding:5px 0px;{if $browse_count >= $smarty.const.MAX_UPLOAD_POSTER}display:none;{/if}">
													...
													{/if}
                                                    <input type="hidden" name="poster_images" id="poster_images" value="{$poster_images}" class="" />
									 ...
									 {/if}	
                                        <input type="reset" value="Reset" class="submit-btn" />
                                         <input type="button" value="Cancel"  class="submit-btn" onclick="javascript:history.back()"/>
                                     </div>
                                     <div class="clear"></div>
                                </div>
                            </form>                       
