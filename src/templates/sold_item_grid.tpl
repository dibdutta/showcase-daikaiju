                    	...
                    	{if $total > 0}
							...
							<div class="left-area">
									...
									{if $smarty.request.mode=='search_sold'}
										<li class="list"><a href="sold_item.php?view_mode=list&mode=search_sold&search_sold={$smarty.request.search_sold|urlencode}">&nbsp;</a> </li>
									{else}
                                        <li class="list"><a href="sold_item.php?view_mode=list">&nbsp;</a> </li>
									{/if}	
                                        |
