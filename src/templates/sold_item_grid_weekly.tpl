            ...
            <div id="tabbed-inner-nav">
				<div class="tabbed-inner-nav-left">
					<ul class="menu">
                        ...
                        <li class="active"><a href="{$actualPath}/sold_item.php?mode=weekly"><span>Auction</span></a></li>
                    	...
                    	{if $total > 0}
							...
							<div class="left-area_auction" style="width:150px;">
									...
									{if $smarty.request.mode=='search_sold_weekly'}
										<li class="list"><a href="sold_item.php?view_mode=list&mode=search_sold_weekly&search_sold={$smarty.request.search_sold|urlencode}">&nbsp;</a> </li>
									{else}
                                        <li class="list"><a href="sold_item.php?view_mode=list&mode=weekly">&nbsp;</a> </li>
									{/if}	
                                        |
                                             ...
                                             <div class="inner-cntnt-each-poster" id="item_{$smarty.section.counter.index}">
                                                <div id="gallery_{$smarty.section.counter.index}" class="image-hldr">
													...
													<div class="pb05 pl10 pr10 tac" style="height:40px;">
														<h3><a class="gridView" href="{$actualPath}/buy.php?mode=poster_details&auction_id={$dataJstFinishedAuction[counter].auction_id}" style="cursor:pointer;" >{$dataJstFinishedAuction[counter].poster_title}&nbsp;{*if $smarty.session.sessUserID <> ""}(#{$dataJstFinishedAuction[counter].poster_sku}){/if*}</a> </h3>
													</div>
                                                </div>
