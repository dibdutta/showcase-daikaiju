                                             ...
                                             <div class="inner-cntnt-each-poster" id="item_{$smarty.section.counter.index}">
                                                <div id="gallery_{$smarty.section.counter.index}" class="image-hldr">
													...
													<div class="pb05 pl10 pr10 tac" style="height:40px;">
														<h3><a class="gridView" href="{posterUrl id=$dataJstFinishedAuction[counter].auction_id title=$dataJstFinishedAuction[counter].poster_title}" style="cursor:pointer;" >{$dataJstFinishedAuction[counter].poster_title}&nbsp;{*if $smarty.session.sessUserID <> ""}(#{$dataJstFinishedAuction[counter].poster_sku}){/if*}</a> </h3>
													</div>
                                                </div>
