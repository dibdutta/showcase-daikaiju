            ...
            <div id="tabbed-inner-nav">
				<div class="tabbed-inner-nav-left">
					<ul class="menu">
                        ...
                        <li class="active" ><a href="{$actualPath}/sold_item.php?mode=fixed"><span>Fixed Price</span></a></li>
					...
					{if $errorMessage<>""}<div class="messageBox">{$errorMessage}</div>{/if}
                    	{if $total > 0}
							...
							<div class="left-area">
									...
									{if $smarty.request.mode=='search_sold_fixed'}
										<li class="list"><a href="sold_item.php?view_mode=list&mode=search_sold_fixed&search_sold={$smarty.request.search_sold|urlencode}">&nbsp;</a> </li>
									{else}
                                        <li class="list"><a href="sold_item.php?view_mode=list&mode=fixed">&nbsp;</a> </li>
									{/if}	
                                        |
                        ...
                        <input type="hidden" value="{$smarty.request.toshow}" name="toshow" >
							...
							<div class="soldSearchblock">
                            	...
                            	<input type="text" style="width:232px; height:23px;border:0px solid #cecfd0; padding:3px 0 0 0;" class="midSearchbg_edit fll" id="search_sold" name="search_sold" {if $smarty.request.mode == 'search_sold_fixed'} value="{$smarty.request.search_sold}" {else} value="Search sold items by their title.."{/if} onfocus="clear_text()"  />
