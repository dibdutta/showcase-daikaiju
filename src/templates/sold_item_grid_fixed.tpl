                    	...
                    	{if $total > 0}
							...
							<div class="left-area">
									...
									{if $smarty.request.mode=='search_sold_fixed'}
										<li class="list"><a href="sold_item?view_mode=list&mode=search_sold_fixed&search_sold={$smarty.request.search_sold|urlencode}">&nbsp;</a> </li>
									{else}
                                        <li class="list"><a href="sold_item?view_mode=list&mode=fixed">&nbsp;</a> </li>
									{/if}	
                                        |
