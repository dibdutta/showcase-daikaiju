			...
			test_enter_for_bid(auc_id);
                                        ...
                                        {if $auctionDetails[0].auction_is_sold=='0'}
                                          ...
                                          {elseif $auctionDetails[0].auction_is_sold=='1'}
                                            ...
                                            {if $smarty.session.sessUserID <> ""}
												 ...
												 <div class="buy-text"><b class="BigFont"   >{$auctionDetails[0].count_bid} Bids</b></div>
												 </div>
											 {else}
                          ...
                          <tr>
                            ...
                            {if $auctionDetails[0].watch_indicator ==0 && $auctionDetails[0].auction_is_sold=='0' &&  $auction_key_approved!='0'}									
                                 ...
                                 <input type="button" value="Watch this item" class="track-btn"  onclick="add_watchlist_for_details({$auctionDetails[0].auction_id});" />
