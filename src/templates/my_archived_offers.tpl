                                               ...
                                               <div style="margin:0; border-bottom:1px solid #DFDFDF;">
                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                        ...
                                                        {*<td width="10%"class="text bold">Offer Accepted/Rejected</td>*}
                                                            ...
                                                            <th width="23%" class="text bold">Counter Offer Date</th>
                                                        </tr>
                                                                ...
                                                                <td id="cntr_ofr_status_{$offers[offerCounter].offer_id}" align="left" class="text">
                                                                    {if $offers[offerCounter].cntr_offer_id > 0}
                                                                        {if $offers[offerCounter].cntr_ofr_offer_is_accepted == 0}
                                                                            <div style="float:left; padding-right:10px"><input type="button" value="Accept" class="track-btn-small" onclick="acceptOffer({$auctionRows[counter].auction_id}, {$offers[offerCounter].offer_id}, {$offers[offerCounter].cntr_offer_id}, 'buyer',{$offset},{$toshow});" /></div>
                                                                            <div><input type="button" value="Reject" class="track-btn-small" onclick="rejectOffer({$offers[offerCounter].offer_id}, {$offers[offerCounter].cntr_offer_id}, 'buyer',{$offset},{$toshow});" /></div>
