			...
			<div id="inner-left-container">
                ...
                <div class="tabbed-inner-nav-left">
                    <ul class="menu">
                        ...
                        <li class="active"><a href="{$actualPath}/sold_item?mode=weekly"><span>Auctions</span></a></li>
                      ...
                      {if $total > 0}
							...
							<div class="left-area_auction" style="width:150px;">
									...
									{if $smarty.request.mode=='search_sold_weekly'}
										<li class="grid"><a href="sold_item?view_mode=gallery&mode=search_sold_weekly&search_sold={$smarty.request.search_sold|urlencode}"></a> </li>
									{else}
                                        <li class="grid"><a href="sold_item?view_mode=gallery&mode=weekly"></a> </li>
									{/if}                                        
                                    </ul>
                            </div>
