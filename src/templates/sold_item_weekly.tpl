			...
			<div id="inner-left-container">
                ...
                <div class="tabbed-inner-nav-left">
                    <ul class="menu">
                        ...
                        <li class="active"><a href="{$actualPath}/sold_item.php?mode=weekly"><span>Auctions</span></a></li>
                      ...
                      {if $total > 0}
							...
							<div class="left-area_auction" style="width:150px;">
									...
									{if $smarty.request.mode=='search_sold_weekly'}
										<li class="grid"><a href="sold_item.php?view_mode=gallery&mode=search_sold_weekly&search_sold={$smarty.request.search_sold|urlencode}"></a> </li>
									{else}
                                        <li class="grid"><a href="sold_item.php?view_mode=gallery&mode=weekly"></a> </li>
									{/if}                                        
                                    </ul>
                            </div>
						...
						{if $total > 0}
                            <div class="soldSearchblock" style="clear:right;">
                            	...
                            	<input style="width:450px; height:23px;border:0px solid #cecfd0; padding:3px 0 0 5px;" type="text" class="midSearchbg_auction fll" id="search_sold" name="search_sold" {if $smarty.request.mode == 'search_sold_weekly'} value="{$smarty.request.search_sold}" {else} value="Search sold items by their title.."{/if} onfocus="clear_text()"  />
