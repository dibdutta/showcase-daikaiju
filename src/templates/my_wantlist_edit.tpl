                    ...
                    <div class="inner-area-general" style="width: 685px;">
                       ...
                       {if $errorMessage<>""}<div class="messageBox">{$errorMessage}</div>{/if}                  
                        <div class="formarea-listing"> 
                            ...
                            <input type="hidden" name="mode" value="edit_mywant_list" />
                            <input type="hidden" name="encoded_string" value="{$encoded_string}" />
                                     
                                <div class="formarea" style="margin-left:0; text-align:center; width:100%;">                   
                                <table width="690" cellpadding="0" cellspacing="0" border="0" class="listbox" style="border:0;" >
                                    <tr>                                        
										...
										<div><input type="text" name="title"  id="poster_title" value="{$want_data[0].poster_title|htmlspecialchars}" onkeyup="autocom(this.value);" class = "required" /></div>						
...
<!--                                    </tr>-->
                                ...
                                <div class="clear"></div>
                                <div class="btn-box">     
                                    <input type="submit" id="submit" value="Update" class="submit-btn" />
<!--                                    <input type="reset" value="reset" class="submit-btn" />-->
                                    <input type="button"  value="Cancel" class="submit-btn" onclick="javascript: location.href='{$decoded_string}';" />
                                </div>
                                <div class="clear"></div>
