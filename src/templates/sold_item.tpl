                        ...
                        <input type="hidden" value="{$smarty.request.toshow}" name="toshow" >
							...
							<div class="soldSearchblock">
                             <div style="width:270px; height:26px;border:1px solid #cecfd0; float:left;">   
                            	<input style="width:232px; height:23px;border:0px solid #cecfd0; padding:3px 0 0 0;" type="text" class="midSearchbg_edit fll" id="search_sold" name="search_sold" {if $smarty.request.mode == 'search_sold'} value="{$smarty.request.search_sold}" {else} value="Search sold items by their title.."{/if} onfocus="clear_text()"  />
                            ...
                            <div class="buylist pt20">
                          	...
                          	<table width="711" border="0" cellspacing="0" cellpadding="0" class="mb30">
								  <tr>
									...
									<div><img  class="image-brdr" src="{$dataJstFinishedAuction[counter].image_path}"  onclick="redirect_poster_details({$dataJstFinishedAuction[counter].auction_id}{if $dataJstFinishedAuction[counter].fk_auction_type_id == 1}, 1{else}, 0{/if}, 1);" style="cursor:pointer;" /></div>
