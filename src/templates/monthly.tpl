...
if(radList[i].checked) radList[i].checked = false;
				...
				var html = '<div id="photo_'+randCount+'" style="float:left; width:110px; padding:0px 2px 0 1px; margin:0px;"><img style="border:3px solid #474644;" src="'+image+'" height="78" width="100" /><input type="radio" name="is_default" style=" margin-left:40px;" value="'+fileObj.name+'" '+checked+' /><br /><img src="{/literal}{$smarty.const.CLOUD_STATIC}delete-icon.png{literal}" style=" margin-left:32px;" onclick="deletePhoto(\'photo_'+randCount+'\', \''+fileObj.name+'\', \'new\')" /></div>';
				$("#photos").append(html);
	...
	$('#chk_submit').click(function() {
		var ind= $('#chk_clicked').val();
		 ...
		 //$('#chk_clicked').val()=2;
		 document.getElementById('chk_clicked').value=2;
		});
});
        ...
        <div id="inner-left-container">
            ...
            <div class="innerpage-container-main">            	
                    ...
                    <div class="black-midrept">
                        <span class="white-txt"><strong>Manual Upload for Monthly Auction</strong></span>
                ...
                <div class="mid-rept-bg">                	
                    <div class="inner-area-general">
                        ...
                        <form name="posterUpload" id="posterUpload" action="" method="post" enctype="multipart/form-data">
                             <input type="hidden" name="chk_clicked" id="chk_clicked" value="1" />
							 <input type="hidden" name="cnt" id="cnt" value="{$cnt}" />
                            <input type="hidden" name="mode" value="monthly_upload" />
                            <input type="hidden" name="random" value="{$random}" />
                            <div class="formarea-listing">  
                             <span>Fields marked <span class="mandatory">*</span> are mandatory</span>                              
                                <table border="0" cellpadding="0" cellspacing="0" class="listbox" >
                                    <tr>
										...
										<div >
                                            <select name="event_month" class="monthly_event_select required">
                                                ...
                                                {section name=counter loop=$eventRows}
                                                    <option value="{$eventRows[counter].event_id}" {if $event_month == $eventRows[counter].event_id} selected {/if}>{$eventRows[counter].event_title} ({$eventRows[counter].event_start_date|date_format:'%D'} - {$eventRows[counter].event_end_date|date_format:'%D'} )</option>
                                                {/section}
                                            </select>
										</div>	
                                    ...
                                    <tr>
                                        <td colspan="3" valign="top"><label>Description<span class="red-star">*</span></label></td>
...
{*</div>*}
                                    ...
                                    <tr>
                                        <td colspan="3" valign="top">
                                            <p style="font-family:Arial, Helvetica, sans-serif; font-size:11px;line-height:40px;">
                                            please give a detailed description of your item including any restoration / backing</p>
                                        </td>
                                    </tr>
<!--                                    <tr>-->
...
<!--                                    </tr> -->
                                    ...
                                    <tr>
                                        <td valign="top">
                                            ...
                                            <div class="txtboxprice"><input type="text" name="asked_price" value="{$asked_price}" maxlength="8" class="formlisting-txtfield-price required" /></div>
                                            <div class="text-price">.00</div>
                                            <div class="list-err">{$asked_price_err}</div>
                                        </td>                                        
                                        <td valign="top">
                                            <div class="text-price">$</div>
                                            <div class="txtboxprice"><input type="text" name="reserve_price" value="{$reserve_price}" maxlength="8" class="formlisting-txtfield-price" /></div>
                                            <div class="text-price">.00</div>
                                            <div class="list-err">{$reserve_price_err}</div>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                ...
                                <div class="clear"></div>
                                <div class="btn-box">     
                                    <input type="submit" value="Submit" class="submit-btn wymupdate" id="chk_submit"  />
