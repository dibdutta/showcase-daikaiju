...
$(document).ready(function(){
	...
	setInterval(function() { refreshOutgoingOffersOnly(offset,toshow,orderBy,orderType);}, 50000);
})
</script>
<script type="text/javascript">
                                        ...
                                        <tr>
											...
											{if $offers[offerCounter].cntr_offer_id > 0}
												{if $offers[offerCounter].cntr_ofr_offer_is_accepted == 0}
													...
													<div style="margin:0 auto;"><input type="button" value="Reject" style="margin: 0 2px 5px 2px;"  class="track-btn-small" onclick="rejectOfferModified({$offers[offerCounter].offer_id}, {$offers[offerCounter].cntr_offer_id}, 'buyer');" /></div>
