...
<div><a href="#"><img  class="image-brdr"  src="{$auctionItems[counter].image_path}"  onclick="redirect_poster_details({$auctionItems[counter].auction_id});" style="cursor:pointer;"  /></a>
