            ...
            <div id="inner-left-container">
                <div class="innerpage-container-main">
                    ...
                    <div class="black-midrept">
                        <span class="white-txt"><strong>{if $pageHeaderName <> ""}{$pageHeaderName}{/if}</strong></span>
                    ...
                    <div class="mid-rept-bg">
                        ...
                        <p><img src="http://3c514cb7d2d88d109eb9-1000d3d367b7fad333f1e36c27dd4ec3.r35.cf2.rackcdn.com/online_payment_not_available.gif" /></p>
                        </div>
                        </div>
                        <div class="clear"></div>
                    </div>
