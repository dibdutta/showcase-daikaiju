...
<?php if ((defined('PHP_SELF') ? constant('PHP_SELF') : null) != '/myselling.php' && (defined('PHP_SELF') ? constant('PHP_SELF') : null) != '/edit_myauction.php') {?>
	<?php echo '<script'; ?>
 src="https://d2m46dmzqzklm5.cloudfront.net/js/jquery-1.10.2.js"><?php echo '</script'; ?>
>
	<?php echo '<script'; ?>
 src="https://d2m46dmzqzklm5.cloudfront.net/js/jquery-ui.js"><?php echo '</script'; ?>
>
<?php } else { ?>
	<?php echo '<script'; ?>
...
var checkcart = <?php echo $_smarty_tpl->tpl_vars['totalCartCount']->value;?>
;
//if(checkcart >0){
...
function timerIncrement() {
	var userId = '<?php echo $_SESSION['sessUserID'];?>
'; 
    idleTime = idleTime + 1;
...
function timerIncrement1(list,id) {
    ...
    var type= '<?php echo $_REQUEST['list'];?>
'
...
" />
                <input type="hidden" name="genre_id" id="genre_id" value="<?php echo $_REQUEST['genre_id'];?>
" />
                <input type="hidden" name="decade_id" id="decade_id" value="<?php echo $_REQUEST['decade_id'];?>
" />
                <input type="hidden" name="country_id" id="country_id" value="<?php echo $_REQUEST['country_id'];?>
" />
                <?php if ($_REQUEST['mode'] != 'refinesrcStills') {?>
                  <input type="hidden" name="list" id="list" value="<?php echo $_REQUEST['list'];?>
" />
				<?php } else { ?> 
...
" />
					<input type="hidden" name="auction_week_id" value="<?php echo $_REQUEST['auction_week_id'];?>
" />
                    <input type="text" name="keyword"  id="search_for_poster" class="srchbox-txt"  <?php if ($_REQUEST['mode'] == 'key_search_global' || $_REQUEST['mode'] == 'key_search_upcoming' || $_REQUEST['mode'] == 'key_search_stills') {?> value="<?php echo $_REQUEST['keyword'];?>
"<?php } else { ?> value="Search For Items by Title,Descriptions,Genre.."  <?php }?> onclick="clear_text_for_poster();" />
                    <!--<div style="float:left;"><img src="<?php echo (defined('CLOUD_STATIC') ? constant('CLOUD_STATIC') : null);?>
search_right_crn.png" width="11" height="35" /></div>-->
                    <!--<div class="styled-select">
                        <select name="search_type" >
                            <option value="title" <?php if ($_REQUEST['search_type'] == 'title') {?>selected="selected" <?php }?>>Poster Titles</option>
                            <option value="title_desc" <?php if ($_REQUEST['search_type'] == 'title_desc') {?>selected="selected" <?php }?>>Poster Descriptions</option>
							<option value="stills" <?php if ($_REQUEST['search_type'] == 'stills') {?>selected="selected" <?php }?>>Photo Titles</option>
                            <option value="stills_desc" <?php if ($_REQUEST['search_type'] == 'stills_desc') {?>selected="selected" <?php }?>>Photo Descriptions</option>
                        </select>
                    </div>-->
...
)"><?php echo $_smarty_tpl->tpl_vars['rightPanelCatRows']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_counter']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_counter']->value['index'] : null)]['cat_value'];?>
</a>
						</li>
						<?php }?>
            			<?php
...
)"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['rightPanelCatRows']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_counter']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_counter']->value['index'] : null)]['cat_value'], ENT_QUOTES, 'UTF-8', true);?>
</a>
...
<!--Page Ends-->
<?php if ((defined('PHP_SELF') ? constant('PHP_SELF') : null) != '/buy.php' && (defined('PHP_SELF') ? constant('PHP_SELF') : null) != '/user_watching.php') {?>
    <?php echo '<script'; ?>
 type="text/javascript" src="https://d2m46dmzqzklm5.cloudfront.net/js/jquery-validate.js"><?php echo '</script'; ?>
>
<?php }?>
