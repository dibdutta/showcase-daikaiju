<?php /* Smarty version 2.6.14, created on 2017-03-04 13:53:32
         compiled from admin_view_weekly_auction_manager.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', 'admin_view_weekly_auction_manager.tpl', 166, false),)), $this); ?>
...
<br /><span class="err"><?php echo $this->_tpl_vars['asked_price_err']; ?>
                                            ...
                                            <tr class="tr_bgcolor">
												...
												<td class="smalltext">$<?php echo ((is_array($_tmp=$this->_tpl_vars['auctionRow'][0]['auction_buynow_price'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2) : number_format($_tmp, 2)); ?>
</td>
											</tr>
                                            <tr class="tr_bgcolor">
												<td class="bold_text" valign="top"><span class="err">*</span>Start Date :</td>
												<td class="smalltext"><?php echo $this->_tpl_vars['auctionRow'][0]['auction_start_date']; ?>
</td>
											</tr>
                                            <tr class="tr_bgcolor">
												<td class="bold_text" valign="top"><span class="err">*</span>End Date :</td>
												<td class="smalltext"><?php echo $this->_tpl_vars['auctionRow'][0]['auction_end_date']; ?>
</td>
											</tr>
																					</table>
									</td>
