<?php /* Smarty version 2.6.14, created on 2018-07-22 09:19:06
         compiled from admin_edit_auction_week.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'admin_edit_auction_week.tpl', 72, false),)), $this); ?>
	...
	<tr>
		<td width="100%" align="center">
			<form name="frm_add_event" id="frm_add_event" method="post" action="">
                ...
                <input type="hidden" name="auction_week_id" id="auction_week_id" value="<?php echo $this->_tpl_vars['auction_week'][0]['auction_week_id']; ?>
" />
...
" />
				<table width="60%" border="0" cellspacing="1" cellpadding="5" align="center" class="header_bordercolor">
					...
					<tr class="tr_bgcolor">
						...
						<td><input type="text" name="start_date" id="start_date" value="<?php echo $this->_tpl_vars['auction_week'][0]['start_date']; ?>
" class="look required" />
					...
					<tr class="tr_bgcolor">
						...
						<td><input type="text" 1 name="end_date" id="end_date" value="<?php echo $this->_tpl_vars['auction_week'][0]['end_date']; ?>
" class="look required" />
...
" <?php if ($this->_tpl_vars['auction_week'][0]['auction_start_hour'] == $this->_sections['foo']['index']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['hour']; ?>
</option>
                                                        <?php endfor; endif; ?>
                                                    </select>(Hour) :                                            
                                                    <select name="auction_start_min" size="1" tabindex="8" class="look">
                                                        <option value="00" <?php if ($this->_tpl_vars['auction_week'][0]['auction_start_min'] == '00'): ?>selected<?php endif; ?>>00</option>
                                                        <?php unset($this->_sections['foo']);
$this->_sections['foo']['name'] = 'foo';
...
" <?php if ($this->_tpl_vars['auction_week'][0]['auction_start_min'] == $this->_sections['foo']['index']): ?>selected<?php endif; ?>><?php echo $this->_sections['foo']['index']; ?>
</option>
                                                        <?php endfor; endif; ?>
                                                    </select>(Min)
                                                    <select name="auction_start_am_pm" size="1" tabindex="9" class="look">
                                                        <option value="am" <?php if ($this->_tpl_vars['auction_week'][0]['auction_start_am_pm'] == 'am'): ?>selected<?php endif; ?>>AM</option>
                                                        <option value="pm" <?php if ($this->_tpl_vars['auction_week'][0]['auction_start_am_pm'] == 'pm'): ?>selected<?php endif; ?>>PM</option>
                                                    </select>
...
?>
                                                        ...
                                                        <?php endif; ?>
                                                        <option value="<?php echo $this->_tpl_vars['hour']; ?>
" <?php if ($this->_tpl_vars['auction_week'][0]['auction_end_hour'] == $this->_sections['foo']['index']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['hour']; ?>
</option>
                                                        <?php endfor; endif; ?>
                                                    </select>(Hour) :                                            
                                                    <select name="auction_end_min" size="1" tabindex="8" class="look">
                                                        <option value="00" <?php if ($this->_tpl_vars['auction_week'][0]['auction_end_min'] == '00'): ?>selected<?php endif; ?>>00</option>
                                                        <?php unset($this->_sections['foo']);
$this->_sections['foo']['name'] = 'foo';
$this->_sections['foo']['start'] = (int)15;
$this->_sections['foo']['loop'] = is_array($_loop=60) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
                                                            <option value="<?php echo $this->_sections['foo']['index']; ?>
" <?php if ($this->_tpl_vars['auction_week'][0]['auction_end_min'] == $this->_sections['foo']['index']): ?>selected<?php endif; ?>><?php echo $this->_sections['foo']['index']; ?>
</option>
                                                        <?php endfor; endif; ?>
                                                    </select>(Min)
                                                    <select name="auction_end_am_pm" size="1" tabindex="9" class="look">
                                                        <option value="am" <?php if ($this->_tpl_vars['auction_week'][0]['auction_end_am_pm'] == 'am'): ?>selected<?php endif; ?>>AM</option>
                                                        <option value="pm" <?php if ($this->_tpl_vars['auction_week'][0]['auction_end_am_pm'] == 'pm'): ?>selected<?php endif; ?>>PM</option>
                                                    </select>
                    ...
                    <tr class="tr_bgcolor">
						...
						<td><input type="text" size="45" name="event_title" id="event_title" value="<?php echo $this->_tpl_vars['auction_week'][0]['auction_week_title']; ?>
" class="look required" /> 
					...
					<tr class="tr_bgcolor">
                        <td valign="top">&nbsp;</td>
                        <td><input type="checkbox" size="45" name="is_still"  value="1" <?php if ($this->_tpl_vars['auction_week'][0]['is_stills'] == 1): ?>checked="checked" <?php endif; ?>  />
                            &nbsp;Auction For Stills/Photos
                        </td>
                    </tr>
                    <tr class="tr_bgcolor">
                        <td valign="top">Hide Auction From Front End</td>
                        <td><input type="checkbox" size="45" name="is_test"  value="1" <?php if ($this->_tpl_vars['auction_week'][0]['is_test'] == 1): ?>checked="checked" <?php endif; ?> id="is_test" onchange="myFunction()"  />
                            &nbsp;
                        </td>
                    </tr>
					<tr class="tr_bgcolor">
