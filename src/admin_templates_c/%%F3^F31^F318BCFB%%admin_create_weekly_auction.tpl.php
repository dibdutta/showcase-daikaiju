<?php /* Smarty version 2.6.14, created on 2021-01-21 06:24:45
         compiled from admin_create_weekly_auction.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'admin_create_weekly_auction.tpl', 302, false),)), $this); ?>
...
<!--<script type="text/javascript" src="<?php echo $this->_tpl_vars['actualPath']; ?>
/javascript/autocomplete/jquery.autocomplete.js"></script>-->
<!--<link rel="stylesheet" href="<?php echo $this->_tpl_vars['actualPath']; ?>
...
><?php echo $this->_tpl_vars['catRows'][$this->_sections['counter']['index']]['cat_value']; ?>
											...
											<tr class="tr_bgcolor">
												...
												<td class="smalltext"><!--<textarea name="poster_desc" class="look" cols="70" rows="6"><?php echo $this->_tpl_vars['poster_desc']; ?>
</textarea>--><?php echo $this->_tpl_vars['poster_desc']; ?>
...
', 'new')" style=" margin-left:30px;" /></div>
											...
											<tr height="28" class="tr_bgcolor">
												<td align="center" colspan="2"><input type="submit" name="" value="Add" class="button" onclick="submitForm()" />&nbsp;&nbsp;&nbsp;<input type="button" name="cancel" value="Cancel" class="button" onclick="javascript: location.href='<?php echo $this->_tpl_vars['actualPath'];  echo $this->_tpl_vars['decoded_string']; ?>
'; " /></td>
